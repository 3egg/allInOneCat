      ...
      var r = function(t) {
          function r(r, i, n, a, o) {
              ...
              i || n) {
                  ...
                  c.style.background = "rgba(0,0,0," + o.bgAlpha + ")",
                  c.style.left = s.panelX + "px",
                  c.style.top = s.panelY + "px",
                  c.style.pointerEvents = "none",
                  document.body.appendChild(c);
                  var l = document.createElement("div");
                  l.style.color = s.fontColor,
                  l.style.fontSize = s.fontSize + "px",
                  l.style.lineHeight = s.fontSize + "px",
                  l.style.margin = "4px 4px 4px 4px",
                  s.container = l,
                  c.appendChild(l),
                  i && s.addFps(),
                  n && s.addLog()
          ...
          r.prototype.addFps = function() {
              ...
              var c = document.createElement("div");
              this.divCost = c,
              c.innerHTML = '<font  style="color:' + this.cost1Color + '">0<font/> <font  style="color:' + this.cost3Color + '">0<font/>',
              o.appendChild(c),
          ...
          r.prototype.update = function(e, t) {
              ...
              n = this.arrCost[this.arrCost.length - 1][1]) : (r = e.fps,
              i = e.costTicker,
              n = e.costRender,
              ...
              this.showPanle && (m += "<br/>min" + s + " max" + c + " avg" + x,
              this.divDraw.innerHTML = this.lastNumDraw + "<br/>",
              this.divCost.innerHTML = '<font  style="color:#18fefe">' + i + '<font/> <font  style="color:#ff0000">' + n + "<font/>"),
          ...
          ,
          r.prototype.updateWarn = function(e) {
              this.arrLog.push("[Warning]" + e),
              this.updateLogLayout()
          }
          ,
          r.prototype.updateError = function(e) {
              this.arrLog.push("[Error]" + e),
              this.updateLogLayout()
          }
          ,
          r.prototype.updateLogLayout = function() {
              for (this.log.innerHTML = this.arrLog.join("<br/>"); document.body.clientHeight < this.log.offsetHeight + this.fpsHeight + this.panelY + 2 * this.fontSize; )
                  this.arrLog.shift(),
  ...
  !function(t) {
      var r = function(r) {
          ...
          i.prototype.load = function(t) {
              ...
              c.indexOf("firefox") >= 0 && (s.autoplay = !0,
              s.muted = !0),
              s.load(),
              this.originAudio = s,
  ...
  !function(e) {
      ...
      var r = function() {
          function e(e, r, i) {
              ...
              this.context && (this.context.$offsetX = 0,
      ...
      __reflect(r.prototype, "egret.web.CanvasRenderBuffer", ["egret.sys.RenderBuffer"])
  }(t = e.web || (e.web = {}))
}(egret || (egret = {}));
var egret;
!function(e) {
      ...
      var r = function(t) {
          ...
          r.prototype.getLocation = function(t) {
              ...
              var r = document.documentElement
                ...
                , c = t.pageY - a
                , l = c;
              return 90 == this.rotation ? (s = c,
              l = i.width - o) : -90 == this.rotation && (s = i.height - c,
              l = o),
              s /= this.scaleX,
              l /= this.scaleY,
  ...
  !function(t) {
      ...
      var o = function(r) {
          ...
          i.$init = function() {
              ...
              var c, l = i._audioType;
              l == n.WEB_AUDIO && o || l == n.HTML5_AUDIO ? (c = !1,
              i.setAudioType(l)) : (c = !0,
              ...
              c && o && i.setAudioType(n.WEB_AUDIO)) : r.indexOf("iphone") >= 0 || r.indexOf("ipad") >= 0 || r.indexOf("ipod") >= 0 ? (e.Capabilities.$os = "iOS",
              i._System_OS = a.IOS,
              i.getIOSVersion() >= 7 && (i._canUseBlob = !0,
              c && o && i.setAudioType(n.WEB_AUDIO))) : -1 != r.indexOf("windows nt") ? e.Capabilities.$os = "Windows PC" : -1 != r.indexOf("mac os") && (e.Capabilities.$os = "Mac OS");
  ...
  !function(t) {
      ...
      function i(r) {
          if (!s) {
              ...
              if (i.indexOf("egretnative") >= 0 && e.nativeRender)
                  egret_native.addModuleCallback(function() {
                      if (t.Html5Capatibility.$init(),
                      "webgl" == r.renderMode) {
                          var i = r.antialias;
                  ...
                  if (t.Html5Capatibility._audioType = r.audioType,
                  ...
                  n(r.renderMode);
                  var h = void 0;
                  if (r.canvasScaleFactor)
                      h = r.canvasScaleFactor;
                  else if (r.calculateCanvasScaleFactor)
                      h = r.calculateCanvasScaleFactor(e.sys.canvasHitTestBuffer.context);
                  else {
  ...
  !function(t) {
      var r = function(r) {
          ...
          i.prototype.init = function(r, i) {
              ...
              (n.showFPS || n.showLog) && (e.nativeRender || l.displayFPS(n.showFPS, n.showLog, n.logFilter, n.fpsStyles)),
              this.playerOption = n,
              this.container = r,
              this.canvas = s,
              this.stage = a,
          ...
          i.prototype.updateScreenSize = function() {
              ...
              if (!t.userTyping) {
                  ...
                  var g = 0;
                  s ? c == e.OrientationMode.LANDSCAPE ? (g = 90,
                  t.style.top = n + (o - p) / 2 + "px",
                  t.style.left = (a + v) / 2 + "px") : (g = -90,
                  t.style.top = n + (o + p) / 2 + "px",
                  t.style.left = (a - v) / 2 + "px") : (t.style.top = n + (o - v) / 2 + "px",
                  t.style.left = (a - p) / 2 + "px");
                  var y = p / d
                    , x = v / f
                    , m = y * e.sys.DisplayList.$canvasScaleFactor
                    , b = x * e.sys.DisplayList.$canvasScaleFactor;
                  "canvas" == e.Capabilities.$renderMode && (m = Math.ceil(m),
                  b = Math.ceil(b));
                  var w = new e.Matrix;
                  w.scale(y / m, x / b),
  ...
  !function(t) {
      function r(t, r) {
          ...
          var a = r.width
            , o = r.height
            , l = s;
          if (l.style.width = a + "px",
          l.style.height = o + "px",
          s.width = a,
          s.height = o,
          "webgl" == e.Capabilities.$renderMode) {
              var h = void 0;
              t.$renderBuffer ? h = t : (h = new e.RenderTexture,
              h.drawToTexture(new e.Bitmap(t)));
              for (var u = h.$renderBuffer.getPixels(r.x, r.y, a, o), d = new ImageData(a,o), f = 0; f < u.length; f++)
                  d.data[f] = u[f];
          ...
          var p = t
            ...
            , y = p.$bitmapWidth
            , x = p.$bitmapHeight;
          return c.drawImage(p.$bitmapData.source, p.$bitmapX + r.x / e.$TextureScaleFactor, p.$bitmapY + r.y / e.$TextureScaleFactor, y * r.width / i, x * r.height / n, v, g, r.width, r.height),
          l
      }
      function i(t, i, n) {
          try {
          ...
          e.prototype.cacheArrays = function(e, t, r, i, n, a, o, s, c, l, h, u, d, f, p) {
              ...
              if (d) {
                  ...
                  O = u.length; O > A; A += 2)
                      ...
                      L[R + D + 4] = v;
                  if (this.hasMesh)
                      for (var F = 0, P = f.length; P > F; ++F)
                          this.indicesForMesh[this.indexIndex + F] = f[F] + this.vertexIndex;
                  this.vertexIndex += u.length / 2,
                  ...
                  if (this.hasMesh) {
                      ...
                      k[this.indexIndex + 0] = 0 + this.vertexIndex,
                      k[this.indexIndex + 1] = 1 + this.vertexIndex,
                      k[this.indexIndex + 2] = 2 + this.vertexIndex,
                      k[this.indexIndex + 3] = 0 + this.vertexIndex,
                      k[this.indexIndex + 4] = 2 + this.vertexIndex,
                      k[this.indexIndex + 5] = 3 + this.vertexIndex
                  }
                  this.vertexIndex += 4,
                  this.indexIndex += 6
              }
      ...
      var i = function() {
          ...
          i.prototype.drawImage = function(e, t, r, i, n, a, o, s, c, l, h, u, d) {
              ...
              if (!this.contextLost && e && f) {
                  ...
                  p && (this.drawTexture(p, t, r, i, n, a, o, s, c, l, h, void 0, void 0, void 0, void 0, u, d),
                  e.source && e.source.texture && (f.$offsetX = v,
                  f.$offsetY = g,
                  f.restoreTransform()))
              }
          }
          ...
          i.prototype.drawMesh = function(e, t, r, i, n, a, o, s, c, l, h, u, d, f, p, v, g) {
              ...
              if (!this.contextLost && e && y) {
                  ...
                  x && (this.drawTexture(x, t, r, i, n, a, o, s, c, l, h, u, d, f, p, v, g),
                  (e.texture || e.source && e.source.texture) && (y.$offsetX = m,
                  y.$offsetY = b,
                  y.restoreTransform()))
              }
          }
          ...
          i.prototype.drawTexture = function(e, t, r, i, n, a, o, s, c, l, h, u, d, f, p, v, g) {
              ...
              if (!this.contextLost && e && y) {
                  ...
                  void 0 != g && e.smoothing != g && this.drawCmdManager.pushChangeSmoothing(e, g),
                  u && this.vao.changeToMeshIndices();
                  var x = f ? f.length / 3 : 2;
                  this.drawCmdManager.pushDrawTexture(e, x, this.$filter),
          ...
          i.prototype.drawToRenderTarget = function(e, r, i) {
              if (!this.contextLost) {
                  ...
                  if ("blur" == e.type) {
                      var c = e.blurXFilter
                        , l = e.blurYFilter;
                      0 != c.blurX && 0 != l.blurY ? (n = t.WebGLRenderBuffer.create(o, s),
      ...
      var r = function(r) {
          function n(i, n, a) {
              ...
              e.nativeRender)
                  ...
                  a ? o.bufferIdForWasm = 0 : o.bufferIdForWasm = egret_native.NativeDisplayObject.setValuesToRenderBuffer(o),
                  o;
              if (o.rootRenderTarget = new t.WebGLRenderTarget(o.context.context,3,3),
              i && n && o.resize(i, n),
              o.root = a,
              o.root)
          ...
          Object.defineProperty(n.prototype, "width", {
              get: function() {
                  return e.nativeRender ? this.$width : this.rootRenderTarget.width
              },
              enumerable: !0,
              configurable: !0
          }),
          Object.defineProperty(n.prototype, "height", {
              get: function() {
                  return e.nativeRender ? this.$height : this.rootRenderTarget.height
              },
              enumerable: !0,
              configurable: !0
          }),
          n.prototype.resize = function(t, r, i) {
              return t = t || 1,
              r = r || 1,
              e.nativeRender ? (this.$width = t,
              void (this.$height = r)) : (this.context.pushBuffer(this),
              (t != this.rootRenderTarget.width || r != this.rootRenderTarget.height) && (this.context.drawCmdManager.pushResize(this, t, r),
      ...
      var r = ["source-over", "lighter", "destination-out"]
        ...
        , a = function() {
          ...
          a.prototype.drawDisplayObject = function(t, r, i, n, a) {
              var o, s = 0, c = t.$displayList;
              if (c && !a ? ((t.$cacheDirty || t.$renderDirty || c.$canvasScaleX != e.sys.DisplayList.$canvasScaleX || c.$canvasScaleY != e.sys.DisplayList.$canvasScaleY) && (s += c.drawToSurface()),
              o = c.$renderNode) : o = t.$renderDirty ? t.$getRenderNode() : t.$renderNode,
              t.$cacheDirty = !1,
              o) {
                  switch (s++,
                  r.$offsetX = i,
              ...
              if (l)
                  for (var h = l.length, u = 0; h > u; u++) {
                      var d = l[u]
                        ...
                        , p = void 0
                        , v = void 0;
                      1 != d.$alpha && (v = r.globalAlpha,
                      r.globalAlpha *= d.$alpha);
                      var g = void 0;
                      if (d.$useTranslate) {
                          var y = d.$getMatrix();
                          f = i + d.$x,
          ...
          a.prototype.drawWithFilter = function(t, a, o, s) {
              ...
              if (!t.$children || 0 != t.$children.length || t.$renderNode && 0 != t.$renderNode.$getRenderCount()) {
                  var l, h = t.$filters, u = 0 !== t.$blendMode;
                  u && (l = r[t.$blendMode],
                  l || (l = i));
                  ...
                  if (!t.mask && 1 == h.length && ("colorTransform" == h[0].type || "custom" === h[0].type && 0 === h[0].padding)) {
                      ...
                      if (!t.$children || 1 == f)
                          return u && a.context.setGlobalCompositeOperation(l),
                          a.context.$filter = h[0],
                          c += t.$mask ? this.drawWithClip(t, a, o, s) : t.$scrollRect || t.$maskRect ? this.drawWithScrollRect(t, a, o, s) : this.drawDisplayObject(t, a, o, s),
                          a.context.$filter = null,
                          u && a.context.setGlobalCompositeOperation(i),
                          c
                  }
                  var p = this.createRenderBuffer(d.width, d.height);
                  if (p.context.pushBuffer(p),
                  c += t.$mask ? this.drawWithClip(t, p, -d.x, -d.y) : t.$scrollRect || t.$maskRect ? this.drawWithScrollRect(t, p, -d.x, -d.y) : this.drawDisplayObject(t, p, -d.x, -d.y),
                  p.context.popBuffer(),
                  c > 0) {
                      ...
                      v.ty = g.ty,
                      a.useOffset(),
                      a.context.drawTargetWidthFilters(h, p),
                      g.a = v.a,
                      g.b = v.b,
                      g.c = v.c,
                      g.d = v.d,
          ...
          a.prototype.drawWithClip = function(t, a, o, s) {
              ...
              if (d) {
                  var f = d.$getMatrix();
                  if (0 == f.a && 0 == f.b || 0 == f.c && 0 == f.d)
                      return l
              }
              if (d || t.$children && 0 != t.$children.length) {
                  var p = t.$getOriginalBounds()
                    , v = this.createRenderBuffer(p.width, p.height);
                  if (v.context.pushBuffer(v),
                  l += this.drawDisplayObject(t, v, -p.x, -p.y),
                  d) {
                      var g = this.createRenderBuffer(p.width, p.height);
                      g.context.pushBuffer(g);
                      var y = e.Matrix.create();
                      y.copyFrom(d.$getConcatenatedMatrix()),
                      d.$getConcatenatedMatrixAt(t, y),
                      y.translate(-p.x, -p.y),
                      g.setTransform(y.a, y.b, y.c, y.d, y.tx, y.ty),
                      e.Matrix.release(y),
                      l += this.drawDisplayObject(d, g, 0, 0),
                      g.context.popBuffer(),
                      v.context.setGlobalCompositeOperation("destination-in"),
                      v.setTransform(1, 0, 0, -1, 0, g.height),
                      v.globalAlpha = 1;
                      var x = g.rootRenderTarget.width
                        , m = g.rootRenderTarget.height;
                      v.context.drawTexture(g.rootRenderTarget.texture, 0, 0, x, m, 0, 0, x, m, x, m),
                      v.setTransform(1, 0, 0, 1, 0, 0),
                      v.context.setGlobalCompositeOperation("source-over"),
                      n.push(g)
                  }
                  if (v.context.setGlobalCompositeOperation(i),
                  v.context.popBuffer(),
                  l > 0) {
                      l++,
                      ...
                      b.tx = w.tx,
                      b.ty = w.ty,
                      w.append(1, 0, 0, -1, o + p.x, s + p.y + v.height);
                      var E = v.rootRenderTarget.width
                        , T = v.rootRenderTarget.height;
                      a.context.drawTexture(v.rootRenderTarget.texture, 0, 0, E, T, 0, 0, E, T, E, T),
                      u && v.context.popMask(),
                      h && a.context.setGlobalCompositeOperation(i);
                      var _ = a.globalMatrix;
                      _.a = b.a,
                      _.b = b.b,
                      _.c = b.c,
                      _.d = b.d,
          ...
          a.prototype.drawWithScrollRect = function(e, t, r, i) {
              ...
              if (t.$hasScissor || 0 != o.b || 0 != o.c)
                  ...
                  s.enableScissor(y, -b + t.height, m - y, b - x),
                  c = !0
              }
          ...
          a.prototype.renderBitmap = function(t, n) {
              var a = t.image;
              if (a) {
                  var o, s, c, l = t.drawData, h = l.length, u = 0, d = t.matrix, f = t.blendMode, p = t.alpha;
                  if (d) {
                      o = e.Matrix.create();
                  ...
                  var g;
                  if (p == p && (g = n.globalAlpha,
                  n.globalAlpha *= p),
                  t.filter) {
                      for (n.context.$filter = t.filter; h > u; )
                          n.context.drawImage(a, l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], t.imageWidth, t.imageHeight, t.rotated, t.smoothing);
                      n.context.$filter = null
                  } else
                      for (; h > u; )
                          n.context.drawImage(a, l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], t.imageWidth, t.imageHeight, t.rotated, t.smoothing);
                  if (f && n.context.setGlobalCompositeOperation(i),
                  p == p && (n.globalAlpha = g),
                  d) {
          ...
          a.prototype.renderMesh = function(t, n) {
              var a, o, s, c = t.image, l = t.drawData, h = l.length, u = 0, d = t.matrix, f = t.blendMode, p = t.alpha;
              if (d) {
                  a = e.Matrix.create();
                  var v = n.globalMatrix;
                  a.a = v.a,
              ...
              t.filter) {
                  for (n.context.$filter = t.filter; h > u; )
                      n.context.drawMesh(c, l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], t.imageWidth, t.imageHeight, t.uvs, t.vertices, t.indices, t.bounds, t.rotated, t.smoothing);
                  n.context.$filter = null
              } else
                  for (; h > u; )
                      n.context.drawMesh(c, l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], l[u++], t.imageWidth, t.imageHeight, t.uvs, t.vertices, t.indices, t.bounds, t.rotated, t.smoothing);
          ...
          a.prototype.renderText = function(r, i) {
              ...
              if (!(0 >= n || 0 >= a) && n && a && 0 != r.drawData.length) {
                  ...
                  var l = r.x * o
                    , h = r.y * s;
                  if ((r.$canvasScaleX != o || r.$canvasScaleY != s) && (r.$canvasScaleX = o,
                  r.$canvasScaleY = s,
                  r.dirtyRender = !0),
                  this.canvasRenderBuffer && this.canvasRenderBuffer.context ? r.dirtyRender && this.canvasRenderBuffer.resize(n, a) : (this.canvasRenderer = new e.CanvasRenderer,
                  ...
                  this.canvasRenderBuffer.context) {
                      ...
                      l || h ? (r.dirtyRender && this.canvasRenderBuffer.context.setTransform(o, 0, 0, s, -l, -h),
                      i.transform(1, 0, 0, 1, l / o, h / s)) : (1 != o || 1 != s) && this.canvasRenderBuffer.context.setTransform(o, 0, 0, s, 0, 0),
                      r.dirtyRender) {
                          var u = this.canvasRenderBuffer.surface;
                          this.canvasRenderer.renderText(r, this.canvasRenderBuffer.context);
                          var d = r.$texture;
                          d ? i.context.updateTexture(d, u) : (d = i.context.createTexture(u),
                          r.$texture = d),
                      ...
                      (l || h) && (r.dirtyRender && this.canvasRenderBuffer.context.setTransform(o, 0, 0, s, 0, 0),
          ...
          a.prototype.renderGraphics = function(r, i, n) {
              ...
              if (!(0 >= a || 0 >= o) && a && o && 0 != r.drawData.length) {
                  ...
                  (1 > a * s || 1 > o * c) && (s = c = 1),
                  (r.$canvasScaleX != s || r.$canvasScaleY != c) && (r.$canvasScaleX = s,
                  r.$canvasScaleY = c,
                  r.dirtyRender = !0),
                  a *= s,
                  o *= c;
                  ...
                  a = l,
                  o = h,
                  this.canvasRenderBuffer && this.canvasRenderBuffer.context ? (r.dirtyRender || n) && this.canvasRenderBuffer.resize(a, o) : (this.canvasRenderer = new e.CanvasRenderer,
