...
!function(t) {
  var e = function(e) {
      ...
      i.prototype.$hitTest = function(t, i) {
          ...
          if (n || this.$Group[5])
              return n;
          if (!this.$visible || !this.touchEnabled || 0 === this.scaleX || 0 === this.scaleY || 0 === this.width || 0 === this.height)
              return null;
...
!function(t) {
  var e = function(e) {
      ...
      i.prototype.$setTouchEnabled = function(t) {
          ...
          var i = this.$Component;
          i[7] = t,
          i[3] && e.prototype.$setTouchEnabled.call(this, t)
      }
      ,
...
!function(t) {
  ...
  !function(t) {
      ...
      var n = []
        ...
        , m = function() {
          ...
          e.prototype.parseClass = function(e, i) {
              t.exmlConfig || (t.exmlConfig = new t.EXMLConfig),
              this.currentXML = e,
              this.currentClassName = i,
              this.delayAssignmentDic = {},
              this.idDic = {},
              this.stateCode = [],
              this.stateNames = [],
              ...
              this.currentClass = new t.EXClass,
              this.stateIds = [];
              var n = i.lastIndexOf(".");
              -1 != n ? this.currentClass.className = i.substring(n + 1) : this.currentClass.className = i,
              this.startCompile();
          ...
          e.prototype.startCompile = function() {
              ...
              this.isSkinClass = e == s,
              this.currentClass.superClass = e,
              this.getStateNames();
              ...
              if (e)
                  for (var i = e.length, n = 0; i > n; n++) {
                      ...
                      if (1 == r.nodeType && r.namespace && !this.isInnerClass(r))
                          if (this.addIds(r.children),
                          r.namespace != t.NS_W && r.localName) {
                              if (this.isProperty(r)) {
                                  ...
                                  if (l) {
                                      ...
                                      null == l.match(u) && egret.$warn(2022, l),
                                      null != l.match(new RegExp(/ /g)) && egret.$warn(2022, l),
                                      -1 == this.skinParts.indexOf(l) && this.skinParts.push(l),
                                      this.createVarForNode(r),
                                      this.isStateNode(r) && this.stateIds.push(l)
                                  } else
                                      this.createIdForNode(r),
                                      this.isStateNode(r) && this.stateIds.push(r.attributes.id)
                              }
                          } else
                              ;
                  }
          ...
          e.prototype.isInnerClass = function(e) {
              if (e.hasOwnProperty("isInnerClass"))
                  return e.isInnerClass;
          ...
          e.prototype.createFuncForNode = function(e) {
              ...
              if (n)
                  return this.createBasicTypeForNode(e);
              var r = this.getClassNameOfNode(e)
                , o = new t.EXFunction
                , s = "_i"
                , a = e.attributes.id;
              o.name = a + s,
              this.currentClass.addFunction(o);
              var h = new t.EXCodeBlock;
              o.codeBlock = h;
              var l = "t";
              "Object" == i ? h.addVar(l, "{}") : h.addVar(l, "new " + r + "()");
              var u = !!this.currentClass.getVariableByName(a);
              u && h.addAssignment("this." + a, l),
              this.addAttributesToCodeBlock(h, l, e),
              this.initlizeChildNode(e, h, l);
          ...
          e.prototype.addAttributesToCodeBlock = function(e, i, n) {
              var r, o, s = n.attributes, a = Object.keys(s);
              a.sort();
              for (var h = a.length, l = 0; h > l; l++)
                  if (r = a[l],
                  this.isNormalKey(r) && (o = s[r],
                  r = this.formatKey(r, o),
                  o = this.formatValue(r, o, n))) {
                      if (this.currentClass.getVariableByName(o)) {
                          var u = "this."
                            , p = s.id
                            , c = u + p + " = t;";
                          this.currentClass.getVariableByName(p) || this.createVarForNode(n),
                          e.containsCodeLine(c) || e.addCodeLineAt(c, 1);
                          var d = new t.EXCodeBlock;
                          "this" == i ? d.addAssignment(i, u + o, r) : (d.startIf(u + p),
                          d.addAssignment(u + p, u + o, r),
                          d.endBlock()),
                          this.delayAssignmentDic[o] || (this.delayAssignmentDic[o] = []),
                          this.delayAssignmentDic[o].push(d),
                          o = u + o
                      }
                      ...
                      if (1 == c.nodeType && c.namespace != t.NS_W)
                          if (this.isInnerClass(c)) {
                              ...
                              if (this.isProperty(c)) {
                                  if (!this.isNormalKey(g))
                                      continue;
                                  var y = t.exmlConfig.getPropertyType(c.localName, a);
                                  if (!y)
                                      continue;
                                  if (!c.children || 0 == c.children.length)
                                      continue;
          ...
          e.prototype.parseInnerClass = function(t) {
              ...
              var o = this.currentClass.className + "$" + t.localName + r++
                , s = i.parseClass(t, o);
              return this.currentClass.addInnerClass(s),
              n.push(i),
              o
          }
          ,
          ...
          e.prototype.isProperty = function(e) {
              if (e.hasOwnProperty("isProperty"))
                  return e.isProperty;
              var i, n = e.localName;
          ...
          e.prototype.formatValue = function(e, i, n) {
              ...
              if (a) {
                  ...
                  var u = "this";
                  n !== this.currentXML && (u += "." + n.attributes.id),
                  this.bindings.push(new t.EXBinding(u,e,a.templates,a.chainIndex)),
                  i = ""
              } else if (s == h) {
                  i = "new " + h + "(" + i + ")"
              } else if (s == p)
                  -1 != i.indexOf("%") && (i = this.formatString(i));
              else {
                  switch (s) {
                  case l:
              ...
              for (var n = -1 == e.indexOf("+") ? [e] : this.parseTemplates(e), r = [], s = n.length, a = 0; s > a; a++) {
                  ...
                  if (h) {
                      ...
                      if (!("'" == l || '"' == l || l >= "0" && "9" >= l || "-" == l || -1 == h.indexOf(".") && -1 != v.indexOf(h))) {
                          ...
                          var u = h.split(".")[0];
                          u != o && -1 == this.skinParts.indexOf(u) && (h = o + "." + h),
                          n[a] = '"' + h + '"',
                          r.push(a)
                      }
                  } else
          ...
          e.prototype.createConstructFunc = function() {
              ...
              e.addEmptyLine();
              var i = "this";
              if (this.addAttributesToCodeBlock(e, i, this.currentXML),
              this.declarations) {
              ...
              f.addReturn(c),
              d.codeBlock = f,
              this.currentClass.addFunction(d),
              this.currentXML.attributes.id = "",
              this.createStates(this.currentXML);
              for (var y, g = this.currentXML, v = (this.getClassNameOfNode(g),
              g.attributes), m = Object.keys(v), $ = m.length, E = 0; $ > E; E++) {
                  var C = m[E]
                    , _ = v[C]
                    , b = C.indexOf(".");
                  if (-1 != b) {
          ...
          e.prototype.getStateNames = function() {
              ...
              if (n == c) {
                  ...
                  var o, s, a = this.stateNames, h = e.children;
                  if (h)
                      for (var l = h.length, u = 0; l > u; u++)
                          if (s = h[u],
                          1 == s.nodeType && "states" == s.localName) {
                              s.namespace = t.NS_W,
                              o = s.children;
                              break
                          }
                  if (o || r)
                      if (r)
                          for (var p = r.split(","), d = p.length, u = 0; d > u; u++) {
                              var f = p[u].trim();
                              f && (-1 == a.indexOf(f) && a.push(f),
                              this.stateCode.push(new t.EXState(f)))
                          }
                      else
                              ...
                              if (1 == g.nodeType) {
                                  ...
                                  if (m.stateGroups)
                                      for (var $ = m.stateGroups.split(","), E = $.length, C = 0; E > C; C++) {
                                          var _ = $[C].trim();
                                          _ && (-1 == a.indexOf(_) && a.push(_),
                                          v.push(_))
                                      }
                                  var f = m.name;
                                  -1 == a.indexOf(f) && a.push(f),
                                  this.stateCode.push(new t.EXState(f,v))
                              }
                          }
              }
          }
          ...
          e.prototype.createStates = function(e) {
              ...
              if (i)
                  for (var n = i.length, r = 0; n > r; r++) {
                      var o = i[r];
                      if (1 == o.nodeType && !this.isInnerClass(o) && (this.createStates(o),
                      o.namespace != t.NS_W && o.localName))
                          if (this.isProperty(o)) {
                              ...
                              var p = this.getClassNameOfNode(e)
                                , c = (t.exmlConfig.getPropertyType(s, p),
                              h[0])
                                , d = void 0;
                              1 == c.nodeType ? (this.createFuncForNode(c),
                              this.checkIdForState(c),
                              d = "this." + c.attributes.id) : d = this.formatValue(s, c.text, e);
                              ...
                              if (this.isStateNode(o)) {
                                  var E = ""
                                    , C = o.parent;
                                  C.localName == u && (C = C.parent),
                                  C && C.parent && this.isProperty(C) && (C = C.parent),
                                  C && C != this.currentXML && (E = C.attributes.id,
                                  this.checkIdForState(C));
                                  ...
                                  if (m.includeIn)
                                      ...
                                      for (var g = 0; T > g; g++)
                                          v = this.stateCode[g],
                                          -1 == S.indexOf(v.name) && b.push(v.name)
                                  }
                                  for (var I = b.length, P = 0; I > P; P++)
                                      if (l = b[P],
                                      f = this.getStateByName(l, o),
                                      f.length > 0)
                                          for (var y = f.length, g = 0; y > g; g++)
                                              v = f[g],
                                              v.addOverride(new t.EXAddItems($,E,_.position,_.relativeTo))
                              }
                              for (var L = Object.keys(m), N = L.length, O = 0; N > O; O++) {
                                  ...
                                  if (-1 != a) {
                                      ...
                                      if (y > 0)
                                          for (var g = 0; y > g; g++)
                                              v = f[g],
                                              B ? v.addOverride(new t.EXSetStateProperty($,D,B.templates,B.chainIndex)) : v.addOverride(new t.EXSetProperty($,D,d))
                                  }
                              }
                          }
                  }
      ...
      t.EXMLParser = m,
      __reflect(m.prototype, "eui.sys.EXMLParser")
  }(e = t.sys || (t.sys = {}))
}(eui || (eui = {}));
var eui;
!function(t) {
  ...
  var e = function(e) {
      ...
      i.prototype.parseSource = function() {
          ...
          i && "string" == typeof i ? t.getAssets(this._source, function(t) {
              i === e._source && egret.is(t, "egret.Texture") && (e.$setTexture(t),
      ...
      i.prototype.setActualSize = function(i, n) {
          t.sys.UIComponentImpl.prototype.setActualSize.call(this, i, n),
          e.prototype.$setWidth.call(this, i),
          e.prototype.$setHeight.call(this, n)
      }
      ,
      i.prototype.childrenCreated = function() {}
      ,
  ...
  var e = t.sys.UIComponentImpl
    , i = function(i) {
      ...
      n.prototype.$invalidateTextField = function() {
          i.prototype.$invalidateTextField.call(this),
          this.invalidateSize()
      }
      ,
...
!function(t) {
  var e = function(t) {
      ...
      return __extends(e, t),
      e.prototype.createNativeDisplayObject = function() {
  ...
  var e = t.sys.UIComponentImpl
    , i = function(i) {
      ...
      n.prototype.$setFont = function(t) {
          return this.$fontForBitmapLabel == t ? !1 : (this.$fontForBitmapLabel = t,
          this.$createChildrenCalled ? this.$parseFont() : this.$fontChanged = !0,
          this.$fontStringChanged = !0,
          !0)
      }
      ,
      ...
      n.prototype.$setFontData = function(t) {
          return t == this.$font ? !1 : (this.$font = t,
      ...
      n.prototype.measure = function() {
          ...
          i.prototype.$setWidth.call(this, r);
          var o = 0 / 0;
          isNaN(this._heightConstraint) ? isNaN(t[9]) ? 1e5 != t[15] && (o = t[15]) : o = t[9] : (o = this._heightConstraint,
          this._heightConstraint = 0 / 0),
          i.prototype.$setHeight.call(this, o),
          this.setMeasuredSize(this.textWidth, this.textHeight),
...
!function(t) {
  ...
  function i(t, e, i, n) {
      if (void 0 === n && (n = !1),
      n && t in p)
          return void (e && e.call(i, p[t], t));
      var r = u[t];
      return r ? void r.push([e, i]) : (u[t] = [[e, i]],
      void h(t, a))
  }
  function n(t, e, i, n) {
      if (void 0 === n && (n = !1),
              ...
              for (var o = t.numChildren, s = 0, a = 0, h = egret.$TempRectangle, l = 0; o > l; l++) {
                  ...
                  if (egret.is(u, r) && u.$includeInLayout) {
                      ...
                      var _ = h.width
                        ...
                        , S = 0 / 0
                        , T = 0 / 0;
                      S = isNaN(c) ? isNaN(f) ? isNaN(y) ? h.x : i - _ - y : f : Math.round((i - _) / 2 + c),
                      T = isNaN(d) ? isNaN(g) ? isNaN(v) ? h.y : n - b - v : g : Math.round((n - b) / 2 + d),
                      u.setLayoutBoundsPosition(S, T),
                      s = Math.max(s, S + _),
                      a = Math.max(a, T + b)
                  }
              }
  ...
  var e = "eui.UIComponent"
    , i = function(i) {
      ...
      n.prototype.updateDisplayListReal = function(i, n) {
          ...
          var y, g, v, m = r.numElements, $ = m, E = o, C = a, _ = 0, b = 0, S = [], T = u, x = this.maxElementSize, I = egret.$TempRectangle;
          for (y = 0; m > y; y++) {
              var P = r.getElementAt(y);
              if (egret.is(P, e) && P.$includeInLayout)
                  if (P.getPreferredBounds(I),
                  x = Math.max(x, I.height),
                  c)
                      _ += I.width;
                  else {
                      var L = P.$UIComponent;
                      isNaN(L[6]) ? T -= I.width : (b += L[6],
          ...
          if (c) {
              if (0 > O) {
                  ...
                  y = 0; m > y; y++)
                      g = r.getElementAt(y),
                      egret.is(g, e) && g.$includeInLayout && (g.getPreferredBounds(I),
                      I.width <= N && (T -= I.width,
                      A--));
                  T = T > 0 ? T : 0
              }
          ...
          for (y = 0; m > y; y++) {
              ...
              egret.is(g, e) && g.$includeInLayout) {
                  if (g.getPreferredBounds(I),
                  k = 0 / 0,
                  c ? (F = 0 / 0,
                  O > 0 ? F = T * I.width / _ : 0 > O && I.width > N && (F = T / A),
                  isNaN(F) || (k = Math.round(F + G),
                  G += F - k)) : k = D[g.$hashCode],
                  d)
                      C = a,
                  ...
                  H = Math.ceil(I.width),
                  z = Math.ceil(I.height),
                  w = Math.max(w, E + H),
                  V = Math.max(V, C + z),
                  E += H + l
              }
          }
          this.maxElementSize = x,
      ...
      n.prototype.updateDisplayListVirtual = function(i, n) {
          ...
          for (var S, T = 0, x = 0, I = 0, P = !1, L = this.elementSizeTable, N = this.startIndex; p >= N; N++) {
              ...
              O = O > 0 ? O : 0,
              x = a + O),
              I = Math.max(I, g.height),
              P || (S = isNaN(L[N]) ? E : L[N],
              S != g.width && (P = !0)),
              L[N] = g.width,
              T = this.getStartPosition(N),
              y.setLayoutBoundsPosition(Math.round(T), Math.round(x)))
          }
          I += a + h,
          o = this.getStartPosition(u) - l + s,
          this.maxElementSize = C,
          r.setContentSize(o, I),
          (P || _ < this.maxElementSize) && r.invalidateSize()
      }
      ,
      ...
      n.prototype.updateDisplayList = function(n, r) {
          ...
          this.$target) {
              ...
              for (var p, c, d, f, y, g = this._orientation == t.TileOrientation.COLUMNS, v = this.startIndex, m = isNaN(this._horizontalGap) ? 0 : this._horizontalGap, $ = isNaN(this._verticalGap) ? 0 : this._verticalGap, E = this._rowCount, C = this._columnCount, _ = this._columnWidth, b = this._rowHeight, S = this.startIndex; u >= S; S++)
                  if (p = this.$useVirtualLayout ? this.target.getVirtualElementAt(S) : this.target.getElementAt(S),
                  egret.is(p, e) && p.$includeInLayout) {
                      ...
                      this.sizeAndPositionElement(p, c, d, _, b),
                      v++
                  }
              var T = s + a
                , x = h + l
  ...
  var e = "eui.UIComponent"
    , i = function(i) {
      ...
      n.prototype.updateDisplayListReal = function(i, n) {
          ...
          var y, g, v, m = r.numElements, $ = m, E = o, C = a, _ = 0, b = 0, S = [], T = p, x = this.maxElementSize, I = egret.$TempRectangle;
          for (y = 0; m > y; y++) {
              var P = r.getElementAt(y);
              if (egret.is(P, e) && P.$includeInLayout)
                  if (P.getPreferredBounds(I),
                  x = Math.max(x, I.width),
                  c)
                      _ += I.height;
                  else {
                      var L = P.$UIComponent;
                      isNaN(L[7]) ? T -= I.height : (b += L[7],
                      v = new t.sys.ChildInfo,
                      v.layoutElement = P,
                      v.percent = L[7],
                      v.min = L[14],
          ...
          for (y = 0; m > y; y++) {
              ...
              egret.is(g, e) && g.$includeInLayout) {
                  ...
                  k = 0 / 0,
                  c ? (F = 0 / 0,
                  O > 0 ? F = T * I.height / _ : 0 > O && I.height > N && (F = T / A),
                  isNaN(F) || (k = Math.round(F + G),
                  G += F - k)) : k = D[g.$hashCode],
                  d)
                      E = o,
          ...
          return t.fitBounds = function(t, n, r, o, h, p, c, d, f, y, g) {
              ...
              !v) {
                  ...
                  if (_ = e(t, r, o, h, p, c, m, $, E, C)) {
                      ...
                      b - l > n && (egret.Point.release(_),
                      _ = null)
                  }
                  var S = void 0;
                  if (S = i(n, r, o, h, p, c, m, $, E, C)) {
                      var T = a(S.x, S.y, r).width;
                      T - l > t && (egret.Point.release(S),
                      S = null)
                  }
                  v = _ && S ? _.x * _.y > S.x * S.y ? _ : S : _ ? _ : S,
