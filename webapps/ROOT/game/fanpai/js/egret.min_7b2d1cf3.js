      ...
      return (
        ...
        (r.prototype.$insertEventBin = function(t, e, i, r, n, a, o) {
          ...
          for (var s = -1, h = t.length, c = 0; h > c; c++) {
            var l = t[c];
            if (l.listener == i && l.thisObject == r && l.target == this)
              return !1;
        ...
        (r.prototype.removeEventListener = function(t, e, i, r) {
          var n = this.$EventDispatcher,
            ...
            o = a[t];
          o &&
            (0 !== n[3] && (a[t] = o = o.concat()),
            this.$removeEventBin(o, e, i),
            0 == o.length && (a[t] = null));
        }),
        (r.prototype.$removeEventBin = function(t, e, i) {
          for (var r = t.length, n = 0; r > n; n++) {
            var a = t[n];
            if (a.listener == e && a.thisObject == i && a.target == this)
        ...
        (r.prototype.$notifyListener = function(t, i) {
          ...
          for (var h = 0; o > h; h++) {
            var c = a[h];
            if (
              (c.listener.call(c.thisObject, t),
              c.dispatchOnce && s.push(c),
  ...
  var i = (function(i) {
    ...
    return (
      ...
      (r.prototype.$updateUseTransform = function() {
        var t = this;
        1 == t.$scaleX && 1 == t.scaleY && 0 == t.$skewX && 0 == t.$skewY
          ? (t.$useTranslate = !1)
          : (t.$useTranslate = !0);
      }),
      ...
      (r.prototype.$getMatrix = function() {
        ...
        return (
          t.$matrixDirty &&
            ((t.$matrixDirty = !1),
            t.$matrix.$updateScaleAndRotation(
              t.$scaleX,
              t.$scaleY,
              t.$skewX,
              t.$skewY
      ...
      (r.prototype.$setMatrix = function(i, r) {
        ...
        (a.a = i.a),
          ...
          (n.$y = i.ty),
          (n.$matrixDirty = !1),
          1 == a.a && 0 == a.b && 0 == a.c && 1 == a.d
            ? (n.$useTranslate = !1)
            : (n.$useTranslate = !0),
          r &&
            ((n.$scaleX = a.$getScaleX()),
            (n.$scaleY = a.$getScaleY()),
            (n.$skewX = i.$getSkewX()),
            (n.$skewY = i.$getSkewY()),
            (n.$skewXdeg = e((180 * n.$skewX) / Math.PI)),
            (n.$skewYdeg = e((180 * n.$skewY) / Math.PI)),
            (n.$rotation = e((180 * n.$skewY) / Math.PI))),
          t.nativeRender &&
            n.$nativeDisplayObject.setMatrix(i.a, i.b, i.c, i.d, i.tx, i.ty);
      }),
      (r.prototype.$getConcatenatedMatrix = function() {
        ...
        i || (i = e.$concatenatedMatrix = new t.Matrix()),
          e.$parent
            ? e.$parent
                ...
                .$preMultiplyInto(e.$getMatrix(), i)
            : i.copyFrom(e.$getMatrix());
        ...
        return (
          a
            ? i.$preMultiplyInto(
                t.$TempMatrix.setTo(1, 0, 0, 1, -a.x - r, -a.y - n),
                i
              )
            : (0 != r || 0 != n) &&
              i.$preMultiplyInto(t.$TempMatrix.setTo(1, 0, 0, 1, -r, -n), i),
      ...
      (r.prototype.$getInvertedConcatenatedMatrix = function() {
        ...
        return (
          e.$invertedConcatenatedMatrix ||
            (e.$invertedConcatenatedMatrix = new t.Matrix()),
      ...
      (r.prototype.$setScaleX = function(e) {
        ...
        if (
          ((i.$scaleX = e),
          (i.$matrixDirty = !0),
          i.$updateUseTransform(),
          t.nativeRender)
        )
          i.$nativeDisplayObject.setScaleX(e);
        else {
          var r = i.$parent;
          r && !r.$cacheDirty && ((r.$cacheDirty = !0), r.$cacheDirtyUp());
          var n = i.$maskedObject;
      ...
      (r.prototype.$setScaleY = function(e) {
        ...
        if (
          ...
          i.$nativeDisplayObject.setScaleY(e);
        else {
          var r = i.$parent;
          r && !r.$cacheDirty && ((r.$cacheDirty = !0), r.$cacheDirtyUp());
          var n = i.$maskedObject;
      ...
      (r.prototype.$setRotation = function(i) {
        ...
        if (i != r.$rotation) {
          ...
          if (
            ...
            (r.$rotation = i),
            (r.$matrixDirty = !0),
            r.$updateUseTransform(),
            t.nativeRender)
          )
            r.$nativeDisplayObject.setRotation(i);
          else {
            var o = r.$parent;
      ...
      (r.prototype.$setSkewX = function(i) {
        ...
        if (i != r.$skewXdeg)
          if (
            ...
            r.$nativeDisplayObject.setSkewX(r.$skewXdeg);
          else {
            var n = r.$parent;
            n && !n.$cacheDirty && ((n.$cacheDirty = !0), n.$cacheDirtyUp());
      ...
      (r.prototype.$setSkewY = function(i) {
        ...
        if (i != r.$skewYdeg)
          if (
            ...
            r.$nativeDisplayObject.setSkewY(r.$skewYdeg);
          else {
            var n = r.$parent;
            n && !n.$cacheDirty && ((n.$cacheDirty = !0), n.$cacheDirtyUp());
            var a = r.$maskedObject;
      ...
      (r.prototype.$getWidth = function() {
        var t = this;
        return isNaN(t.$explicitWidth)
          ? t.$getOriginalBounds().width
          : t.$explicitWidth;
      }),
      (r.prototype.$setWidth = function(t) {
        this.$explicitWidth = isNaN(t) ? 0 / 0 : t;
      }),
      ...
      (r.prototype.$getHeight = function() {
        var t = this;
        return isNaN(t.$explicitHeight)
          ? t.$getOriginalBounds().height
          : t.$explicitHeight;
      }),
      (r.prototype.$setHeight = function(t) {
        this.$explicitHeight = isNaN(t) ? 0 / 0 : t;
      }),
      ...
      (r.prototype.$setAnchorOffsetX = function(e) {
        var i = this;
        (i.$anchorOffsetX = e),
          t.nativeRender && i.$nativeDisplayObject.setAnchorOffsetX(e);
      }),
      ...
      (r.prototype.$setAnchorOffsetY = function(e) {
        var i = this;
        (i.$anchorOffsetY = e),
          t.nativeRender && i.$nativeDisplayObject.setAnchorOffsetY(e);
      }),
      ...
      (r.prototype.$setVisible = function(e) {
        var i = this;
        if (((i.$visible = e), t.nativeRender))
          i.$nativeDisplayObject.setVisible(e);
        else {
          i.updateRenderMode();
          var r = i.$parent;
          r && !r.$cacheDirty && ((r.$cacheDirty = !0), r.$cacheDirtyUp());
      ...
      Object.defineProperty(r.prototype, 'cacheAsBitmap', {
        ...
        set: function(e) {
          ...
          (i.$cacheAsBitmap = e),
            t.nativeRender
              ? i.$nativeDisplayObject.setCacheAsBitmap(e)
              : i.$setHasDisplayList(e);
        },
        enumerable: !0,
        configurable: !0
      }),
      ...
      (r.prototype.$setAlpha = function(e) {
        var i = this;
        if (((i.$alpha = e), t.nativeRender))
          i.$nativeDisplayObject.setAlpha(e);
        else {
          i.updateRenderMode();
          var r = i.$parent;
          r && !r.$cacheDirty && ((r.$cacheDirty = !0), r.$cacheDirtyUp());
      ...
      (r.prototype.$setScrollRect = function(e) {
        var i = this;
        return e || i.$scrollRect
          ? (e
              ? (i.$scrollRect || (i.$scrollRect = new t.Rectangle()),
                i.$scrollRect.copyFrom(e),
                t.nativeRender &&
                  i.$nativeDisplayObject.setScrollRect(
                    e.x,
                    e.y,
                    e.width,
                    e.height
              ...
              : ((i.$scrollRect = null),
                t.nativeRender &&
                  i.$nativeDisplayObject.setScrollRect(0, 0, 0, 0)),
            void (t.nativeRender || i.updateRenderMode()))
          : void i.updateRenderMode();
      }),
      Object.defineProperty(r.prototype, 'blendMode', {
        ...
        set: function(e) {
          ...
          if (((i.$blendMode = r), t.nativeRender))
            i.$nativeDisplayObject.setBlendMode(r);
          else {
            i.updateRenderMode();
            var n = i.$parent;
            n && !n.$cacheDirty && ((n.$cacheDirty = !0), n.$cacheDirtyUp());
            ...
            if (e)
              if (e instanceof r) {
                ...
                e.$maskedObject && (e.$maskedObject.mask = null),
                  ...
                  i.$maskRect &&
                    (t.nativeRender &&
                      i.$nativeDisplayObject.setMaskRect(0, 0, 0, 0),
                    (i.$maskRect = null)),
                  t.nativeRender &&
                    i.$nativeDisplayObject.setMask(e.$nativeDisplayObject.id);
              } else
                i.$maskRect || (i.$maskRect = new t.Rectangle()),
                  i.$maskRect.copyFrom(e),
                  t.nativeRender &&
                    i.$nativeDisplayObject.setMaskRect(
                      e.x,
                      e.y,
                      e.width,
                      e.height
                  ...
                  i.$mask &&
                    ((i.$mask.$maskedObject = null),
                    t.nativeRender || i.$mask.updateRenderMode()),
                  i.mask &&
                    (t.nativeRender && i.$nativeDisplayObject.setMask(-1),
                    (i.$mask = null));
            else
              i.$mask &&
                ((i.$mask.$maskedObject = null),
        ...
        set: function(e) {
          ...
          return r || e
            ? (e && e.length
                ? ((e = e.concat()),
                  (i.$filters = e),
                  t.nativeRender && i.$nativeDisplayObject.setFilters(e))
                : ((i.$filters = null),
                  t.nativeRender && i.$nativeDisplayObject.setFilters(null)),
              void (t.nativeRender || i.updateRenderMode()))
            : ((i.$filters = null),
              void (t.nativeRender
                ? i.$nativeDisplayObject.setFilters(null)
                : i.updateRenderMode()));
        },
        enumerable: !0,
        configurable: !0
      ...
      (r.prototype.getBounds = function(t, e) {
        ...
        var i = this;
        return (
          (t = i.$getTransformedBounds(i, t)),
          e &&
            (0 != i.$anchorOffsetX && (t.x -= i.$anchorOffsetX),
            0 != i.$anchorOffsetY && (t.y -= i.$anchorOffsetY)),
          t
        );
      }),
      ...
      (r.prototype.globalToLocal = function(e, i, r) {
        if (
          (void 0 === e && (e = 0), void 0 === i && (i = 0), t.nativeRender)
        ) {
          egret_native.updateNativeRender();
          var n = egret_native.nrGlobalToLocal(
      ...
      (r.prototype.localToGlobal = function(e, i, r) {
        if (
          ...
          egret_native.updateNativeRender();
          var n = egret_native.nrLocalToGlobal(
              this.$nativeDisplayObject.id,
              e,
              i
            ),
      ...
      (r.prototype.$getOriginalBounds = function() {
        ...
        return (
          i &&
            ((e.x += i.minX),
            (e.y += i.minY),
            (e.width += -i.minX + i.maxX),
            (e.height += -i.minY + i.maxY)),
          e
        );
      }),
      ...
      (r.prototype.updateRenderMode = function() {
        var t = this;
        !t.$visible || t.$alpha <= 0 || t.$maskedObject
          ? (t.$renderMode = 1)
          : t.filters && t.filters.length > 0
          ? (t.$renderMode = 2)
          : 0 !== t.$blendMode || t.$mask
          ? (t.$renderMode = 3)
            ...
            for (var h = s.length, c = 0; h > c; c++) {
              ...
              if ('blur' == l.type) {
                ...
                var d = l.distance || 0,
                  ...
                  $ = 0;
                0 != d &&
                  ((g = d * t.NumberUtils.cos(f)),
                  (g = g > 0 ? Math.ceil(g) : Math.floor(g)),
                  ($ = d * t.NumberUtils.sin(f)),
  ...
  var e = (function(e) {
    ...
    return (
      ...
      (i.prototype.$doAddChild = function(e, r, n) {
        ...
        o && o.removeChild(e), a.$children.splice(r, 0, e), e.$setParent(a);
        var s = a.$stage;
        if (
          (s && e.$onAddToStage(s, a.$nestLevel + 1),
        ...
        if (t.nativeRender)
          a.$nativeDisplayObject.addChildAt(e.$nativeDisplayObject.id, r);
        else if (!a.$cacheDirty) {
          a.$cacheDirty = !0;
          var l = a.$parent;
      ...
      (i.prototype.$doRemoveChild = function(e, r) {
        ...
        if (
          ...
          for (var s = i.$EVENT_REMOVE_FROM_STAGE_LIST; s.length > 0; ) {
            ...
            r &&
              h.$hasAddToStage &&
              ((h.$hasAddToStage = !1),
              h.dispatchEventWith(t.Event.REMOVED_FROM_STAGE)),
              (h.$hasAddToStage = !1),
              (h.$stage = null);
          }
        }
        ...
        o.$setParent(null);
        var c = a.indexOf(o);
        if ((-1 != c && a.splice(c, 1), t.nativeRender))
          n.$nativeDisplayObject.removeChild(o.$nativeDisplayObject.id);
        else if (!n.$cacheDirty) {
          n.$cacheDirty = !0;
          var l = n.$parent;
          l && !l.$cacheDirty && ((l.$cacheDirty = !0), l.$cacheDirtyUp());
      ...
      (i.prototype.doSetChildIndex = function(e, i) {
        ...
        if (n != i)
          if (
            (this.$childRemoved(e, n),
            this.$children.splice(n, 1),
            this.$children.splice(i, 0, e),
            this.$childAdded(e, i),
            t.nativeRender)
          )
            this.$nativeDisplayObject.removeChild(e.$nativeDisplayObject.id),
      ...
      (i.prototype.doSwapChildrenAt = function(e, i) {
        ...
        if (
          ...
          this.$nativeDisplayObject.swapChild(e, i);
        else if (!r.$cacheDirty) {
          r.$cacheDirty = !0;
          var h = r.$parent;
      ...
      (i.prototype.$measureChildBounds = function(e) {
        ...
        if (0 != r) {
          for (var n = 0, a = 0, o = 0, s = 0, h = !1, c = -1; r > c; c++) {
            var l =
              -1 == c ? e : i[c].$getTransformedBounds(this, t.$TempRectangle);
            l.isEmpty() ||
              (h
                ? ((n = Math.min(n, l.x)),
                  (a = Math.max(a, l.x + l.width)),
                  (o = Math.min(o, l.y)),
                  (s = Math.max(s, l.y + l.height)))
                : ((h = !0),
                  (n = l.x),
                  (a = n + l.width),
                  (o = l.y),
      ...
      (i.prototype.$hitTest = function(t, i) {
        ...
        for (
          var s = this.$children, h = !1, c = null, l = s.length - 1;
          l >= 0;
          l--
        ) {
          var u = s[l];
  ...
  var e = (function(e) {
    ...
    return (
      ...
      (i.prototype.$onAddToStage = function(i, r) {
        ...
        var n = this.$texture;
        n && t.BitmapData.$addDisplayObject(this, n.$bitmapData);
      }),
      (i.prototype.$onRemoveFromStage = function() {
        e.prototype.$onRemoveFromStage.call(this);
        var i = this.$texture;
      ...
      (i.prototype.$setTexture = function(e) {
        ...
        return (
          u && !u.$cacheDirty && ((u.$cacheDirty = !0), u.$cacheDirtyUp()), !0
        );
      }),
      ...
      (i.prototype.$refreshImageData = function() {
        var e = this.$texture;
        e
          ? (t.nativeRender && this.setBitmapDataToWasm(e),
            this.setImageData(
              e.$bitmapData,
              e.$bitmapX,
              e.$bitmapY,
      ...
      (i.prototype.$setScale9Grid = function(e) {
        var i = this;
        if (((i.$scale9Grid = e), (i.$renderDirty = !0), t.nativeRender))
          e
            ? i.$nativeDisplayObject.setScale9Grid(e.x, e.y, e.width, e.height)
            : i.$nativeDisplayObject.setScale9Grid(0, 0, -1, -1);
        else {
          var r = i.$parent;
          r && !r.$cacheDirty && ((r.$cacheDirty = !0), r.$cacheDirtyUp());
          var n = i.$maskedObject;
      ...
      Object.defineProperty(i.prototype, 'smoothing', {
        ...
        set: function(t) {
          t != this.$smoothing &&
            ((this.$smoothing = t), (this.$renderNode.smoothing = t));
        },
        enumerable: !0,
        configurable: !0
      }),
      (i.prototype.$setWidth = function(e) {
        ...
        if (
          ((i.$explicitBitmapWidth = e), (i.$renderDirty = !0), t.nativeRender)
        )
          i.$nativeDisplayObject.setWidth(e);
        else {
          var r = i.$parent;
          r && !r.$cacheDirty && ((r.$cacheDirty = !0), r.$cacheDirtyUp());
          var n = i.$maskedObject;
      ...
      (i.prototype.$setHeight = function(e) {
        ...
        if (
          ((i.$explicitBitmapHeight = e), (i.$renderDirty = !0), t.nativeRender)
        )
          i.$nativeDisplayObject.setHeight(e);
        else {
          var r = i.$parent;
          r && !r.$cacheDirty && ((r.$cacheDirty = !0), r.$cacheDirtyUp());
          var n = i.$maskedObject;
      ...
      (i.prototype.$measureContentBounds = function(t) {
        if (this.$bitmapData) {
          var e = isNaN(this.$explicitBitmapWidth)
              ? this.$textureWidth
              : this.$explicitBitmapWidth,
            i = isNaN(this.$explicitBitmapHeight)
              ? this.$textureHeight
              : this.$explicitBitmapHeight;
          t.setTo(0, 0, e, i);
        } else {
      ...
      (i.prototype.$updateRenderNode = function() {
        if (this.$texture) {
          ...
          r
            ? (this.$renderNode instanceof t.sys.NormalBitmapNode &&
                (this.$renderNode = new t.sys.BitmapNode()),
              t.sys.BitmapNode.$updateTextureDataWithScale9Grid(
                this.$renderNode,
                this.$bitmapData,
                r,
                this.$bitmapX,
            ...
            : (this.fillMode == t.BitmapFillMode.REPEAT &&
                this.$renderNode instanceof t.sys.NormalBitmapNode &&
                (this.$renderNode = new t.sys.BitmapNode()),
  ...
  var e = (function(e) {
    ...
    return (
      ...
      (i.prototype.dispose = function() {
        this.$bitmapData &&
          (this.disposeBitmapData && this.$bitmapData.$dispose(),
    ...
    return (
      ...
      (i.prototype.$hitTest = function(e, i) {
        ...
        return c
          ...
          : h
          ? this
          : ((c = t.DisplayObject.prototype.$hitTest.call(this, e, i)),
            c && (c = this.$graphics.$hitTest(e, i)),
            c);
      }),
      (i.prototype.$measureContentBounds = function(t) {
    ...
    return (
      ...
      Object.defineProperty(e.prototype, 'blurX', {
        ...
        set: function(t) {
          var e = this;
          e.$blurX != t &&
            ((e.$blurX = t), (e.$uniforms.blurX = t), e.onPropertyChange());
        },
        enumerable: !0,
        configurable: !0
      }),
      Object.defineProperty(e.prototype, 'blurY', {
        ...
        set: function(t) {
          var e = this;
          e.$blurY != t &&
            ((e.$blurY = t), (e.$uniforms.blurY = t), e.onPropertyChange());
        },
        enumerable: !0,
        configurable: !0
      }),
      Object.defineProperty(e.prototype, 'strength', {
        ...
        set: function(t) {
          this.$strength != t &&
            ((this.$strength = t), (this.$uniforms.strength = t));
        },
        enumerable: !0,
        configurable: !0
      }),
      ...
      Object.defineProperty(e.prototype, 'inner', {
        ...
        set: function(t) {
          this.$inner != t &&
            ((this.$inner = t), (this.$uniforms.inner = t ? 1 : 0));
        },
        enumerable: !0,
        configurable: !0
      }),
      Object.defineProperty(e.prototype, 'knockout', {
        ...
        set: function(t) {
          this.$knockout != t &&
            ((this.$knockout = t), (this.$uniforms.knockout = t ? 0 : 1));
        },
        enumerable: !0,
        configurable: !0
      }),
...
!(function(t) {
  ...
  !(function(t) {
    var e = (function() {
      ...
      return (
        (t.prototype.cleanBeforeRender = function() {
      ...
      return (
        ...
        (t.prototype.drawRoundRect = function(t, e, i, r, n, a) {
          ...
          if ((o > h && (o = h), s > c && (s = c), h === o && c === s))
            return void (o === s
              ? this.drawCircle(t + o, e + s, o)
              : this.drawEllipse(t, e, 2 * o, 2 * s));
          var l = t + i,
            u = e + r,
            p = t + o,
            d = l - o,
      ...
      (i.$dispose = function(e) {
        if (e) {
          ...
          if (r && i._displayList[r]) {
            ...
            t.nativeRender &&
              egret_native.NativeDisplayObject.disposeBitmapData(e),
...
!(function(t) {
  var e = (function(t) {
    ...
    return (
      __extends(e, t), (e.FOCUS_IN = 'focusIn'), (e.FOCUS_OUT = 'focusOut'), e
    );
  })(t.Event);
  ...
  var e = new t.Point(),
    i = (function(i) {
      function r(t, e, r, n, a, o) {
        ...
        return (
          (s.targetChanged = !0), (s.touchDown = !1), s.$initTo(n, a, o), s
        );
      }
      return (
        __extends(r, i),
        ...
        (r.dispatchTouchEvent = function(e, i, n, a, o, s, h, c) {
          if ((void 0 === c && (c = !1), !n && !e.hasEventListener(i)))
            return !0;
...
!(function(t) {
    ...
    return (
      ...
      Object.defineProperty(n.prototype, 'blurX', {
        ...
        set: function(t) {
          var e = this;
          e.$blurX != t &&
            ((e.$blurX = t), (e.blurXFilter.blurX = t), e.onPropertyChange());
        },
        enumerable: !0,
        configurable: !0
      }),
      Object.defineProperty(n.prototype, 'blurY', {
        ...
        set: function(t) {
          var e = this;
          e.$blurY != t &&
            ((e.$blurY = t), (e.blurYFilter.blurY = t), e.onPropertyChange());
        },
        enumerable: !0,
        configurable: !0
      }),
  ...
  var i = (function(e) {
    function i(i) {
      ...
      var r = e.call(this) || this;
      return (
        t.nativeRender ? (r.type = 'blur') : (r.type = 'blurX'),
        (r.$uniforms.blur = { x: i, y: 0 }),
        r.onPropertyChange(),
        r
      );
    }
  ...
  var r = (function(e) {
    function i(i) {
      ...
      var r = e.call(this) || this;
      return (
        t.nativeRender ? (r.type = 'blur') : (r.type = 'blurY'),
        (r.$uniforms.blur = { x: 0, y: i }),
        r.onPropertyChange(),
        r
      );
    }
  ...
  var e = (function(t) {
    function e(e) {
      ...
      return (
        ...
        (i.$uniforms.colorAdd = { x: 0, y: 0, z: 0, w: 0 }),
        i.setMatrix(e),
        i.onPropertyChange(),
        i
      );
    ...
    o = function() {
      for (var t = 0; 36 > t; t++)
        8 === t || 13 === t || 18 === t || 23 === t
          ...
          : 14 === t
          ? (n[t] = '4')
          : (2 >= a && (a = (33554432 + 16777216 * Math.random()) | 0),
            (e = 15 & a),
            (a >>= 4),
            (n[t] = r[19 === t ? (3 & e) | 8 : e]));
      return n.join('');
    ...
    return (
      ...
      Object.defineProperty(i.prototype, 'distance', {
        ...
        set: function(t) {
          var e = this;
          e.$distance != t &&
            ((e.$distance = t), (e.$uniforms.dist = t), e.onPropertyChange());
        },
        enumerable: !0,
        configurable: !0
      }),
      Object.defineProperty(i.prototype, 'angle', {
        ...
        set: function(t) {
          ...
          e.$angle != t &&
            ((e.$angle = t),
            (e.$uniforms.angle = (t / 180) * Math.PI),
            e.onPropertyChange());
        },
        enumerable: !0,
        configurable: !0
      ...
      Object.defineProperty(i.prototype, 'hideObject', {
        ...
        set: function(t) {
          this.$hideObject != t &&
            ((this.$hideObject = t), (this.$uniforms.hideObject = t ? 1 : 0));
        },
        enumerable: !0,
        configurable: !0
      }),
      ...
      (i.prototype.updatePadding = function() {
        ...
        var i = e.distance || 0,
          ...
          a = 0;
        0 != i &&
          ((n = i * t.NumberUtils.cos(r)),
          (n = n > 0 ? Math.ceil(n) : Math.floor(n)),
          (a = i * t.NumberUtils.sin(r)),
...
!(function(t) {
  ...
  var i = (function(i) {
    ...
    return (
      ...
      (r.prototype.lineStyle = function(t, e, i, r, n, a, o, s, h) {
        void 0 === t && (t = 0 / 0),
          void 0 === e && (e = 0),
          void 0 === i && (i = 1),
          void 0 === r && (r = !1),
          ...
          0 >= t
            ...
            : ((e = +e || 0),
              ...
              (this.strokePath = this.$renderNode.lineStyle(t, e, i, a, o, s)),
              h && this.strokePath.setLineDash(h),
              this.$renderNode.drawData.length > 1 &&
      ...
      (r.prototype.drawRect = function(t, e, i, r) {
        ...
        n && n.drawRect(t, e, i, r),
          a && a.drawRect(t, e, i, r),
          this.extendBoundsByPoint(t + i, e + r),
          this.updatePosition(t, e),
          this.dirty();
      }),
      (r.prototype.drawRoundRect = function(t, e, i, r, n, a) {
        (t = +t || 0),
          (e = +e || 0),
          (i = +i || 0),
          (r = +r || 0),
        ...
        var o = this.fillPath,
          s = this.strokePath;
        o && o.drawRoundRect(t, e, i, r, n, a),
          s && s.drawRoundRect(t, e, i, r, n, a);
        var h = (0.5 * n) | 0,
          c = a ? (0.5 * a) | 0 : h,
          l = t + i,
          u = e + r,
        ...
        this.extendBoundsByPoint(t, e),
          this.extendBoundsByPoint(l, u),
          this.updatePosition(l, p),
          this.dirty();
      }),
      (r.prototype.drawCircle = function(t, e, i) {
        ...
        r && r.drawCircle(t, e, i),
          ...
          this.extendBoundsByPoint(t - i - 1, e - i - 1),
          this.extendBoundsByPoint(t + i + 2, e + i + 2),
      ...
      (r.prototype.drawEllipse = function(t, e, i, r) {
        ...
        n && n.drawEllipse(t, e, i, r),
          a && a.drawEllipse(t, e, i, r),
          this.extendBoundsByPoint(t - 1, e - 1),
          this.extendBoundsByPoint(t + i + 2, e + r + 2),
      ...
      (r.prototype.cubicCurveTo = function(t, e, i, r, n, a) {
        (t = +t || 0),
          (e = +e || 0),
          (i = +i || 0),
          (r = +r || 0),
        ...
        var o = this.fillPath,
          s = this.strokePath;
        o && o.cubicCurveTo(t, e, i, r, n, a),
          s && s.cubicCurveTo(t, e, i, r, n, a),
          this.extendBoundsByPoint(t, e),
          this.extendBoundsByPoint(i, r),
      ...
      (r.prototype.drawArc = function(t, i, r, n, a, o) {
        if (!(0 > r || n === a)) {
          (t = +t || 0),
            (i = +i || 0),
            (r = +r || 0),
          ...
          s &&
            ((s.$lastX = this.lastX),
            (s.$lastY = this.lastY),
            s.drawArc(t, i, r, n, a, o)),
            h &&
              ((h.$lastX = this.lastX),
              (h.$lastY = this.lastY),
              h.drawArc(t, i, r, n, a, o)),
            o ? this.arcBounds(t, i, r, a, n) : this.arcBounds(t, i, r, n, a);
          var c = t + Math.cos(a) * r,
            l = i + Math.sin(a) * r;
          this.updatePosition(c, l), this.dirty();
        }
      }),
      (r.prototype.dirty = function() {
        var e = this;
        (e.$renderNode.dirtyRender = !0),
          t.nativeRender && egret_native.dirtyGraphics(e);
      }),
  ...
  var e = Math.PI,
    ...
    a = (function(a) {
      function o(t, e, i, r, n, o) {
        ...
        return (
          (s.a = t), (s.b = e), (s.c = i), (s.d = r), (s.tx = n), (s.ty = o), s
        );
      }
      return (
        __extends(o, a),
        ...
        (o.prototype.$updateScaleAndRotation = function(e, n, a, o) {
          ...
          a == o
            ? ((this.a = s * e), (this.b = h * e))
            : ((this.a = t.NumberUtils.cos(o) * e),
              (this.b = t.NumberUtils.sin(o) * e)),
            (this.c = -h * n),
            (this.d = s * n);
        }),
...
!(function(t) {
    ...
    return (
      ...
      (i.prototype.$updateRenderNode = function() {
        ...
        if (e) {
          ...
          var r = isNaN(this.$explicitBitmapWidth)
              ? this.$textureWidth
              : this.$explicitBitmapWidth,
            n = isNaN(this.$explicitBitmapHeight)
              ? this.$textureHeight
              : this.$explicitBitmapHeight,
  ...
  (t.Mesh = e),
    __reflect(e.prototype, 'http://huiben.lanyaotech.com/fanpai/js/egret.Mesh');
})(egret || (egret = {}));
var egret;
!(function(t) {
  (t.$locale_strings = t.$locale_strings || {}),
    ...
    var i = (function(i) {
      ...
      return (
        ...
        (r.prototype.drawToSurface = function() {
          ...
          if (
            (n.clear(),
            (i = e.systemRenderer.render(this.root, n, this.offsetMatrix)),
            !this.isStage)
          ) {
            var a = n.surface,
              o = this.$renderNode;
            ...
            var s = a.width,
              h = a.height;
            this.bitmapData
              ? ((this.bitmapData.source = a),
                (this.bitmapData.width = s),
                (this.bitmapData.height = h))
              : (this.bitmapData = new t.BitmapData(a)),
        ...
        (r.$setCanvasScale = function(e, i) {
          (r.$canvasScaleX = e),
            (r.$canvasScaleY = i),
            t.nativeRender &&
              egret_native.nrSetCanvasScaleFactor(r.$canvasScaleFactor, e, i);
        }),
...
!(function(t) {
  ...
  !(function(e) {
    function i(i, n, l, u) {
      if (
        (n &&
          ((t.log = function() {
            for (var t = arguments.length, i = '', n = 0; t > n; n++)
              i += arguments[n] + ' ';
          ...
          (t.warn = function() {
            for (var t = arguments.length, i = '', n = 0; t > n; n++)
              i += arguments[n] + ' ';
            e.$warnToFPS(i), console.warn.apply(console, r(arguments));
          }),
          (t.error = function() {
            for (var t = arguments.length, i = '', n = 0; t > n; n++)
              i += arguments[n] + ' ';
            e.$errorToFPS(i), console.error.apply(console, r(arguments));
          })),
        (o = u ? {} : u),
        (n = !!n),
        (this.showFPS = !!i),
        ...
        var p = void 0 === u.x ? 0 : u.x,
          d = void 0 === u.y ? 0 : u.y;
        (a = this.fps = new FPS(this.stage, i, n, l, u)), (a.x = p), (a.y = d);
        for (var f = s.length, g = 0; f > g; g++) a.updateInfo(s[g]);
        s = null;
        for (var $ = h.length, g = 0; $ > g; g++) a.updateWarn(h[g]);
        h = null;
        for (var y = c.length, g = 0; y > g; g++) a.updateError(c[g]);
        c = null;
      }
    }
    function r(t) {
    ...
    var n = (function(r) {
      function n(e, n, a) {
        ...
        return (
          ...
          (o.entryClassName = a),
          (o.stage = n),
          (o.screenDisplayList = o.createDisplayList(n, e)),
          (o.showFPS = !1),
          (o.showLog = !1),
          (o.stageDisplayList = null),
          (o.displayFPS = i),
      ...
      return (
        __extends(n, r),
        (n.prototype.createDisplayList = function(t, i) {
        ...
        (n.prototype.pause = function() {
          this.isPlaying &&
            ((this.isPlaying = !1), t.ticker.$removePlayer(this));
        }),
        (n.prototype.$render = function(e, i) {
          if (t.nativeRender)
            return (
              egret_native.updateNativeRender(), void egret_native.nrRender()
            );
          (this.showFPS || this.showLog) && this.stage.addChild(this.fps);
          var r = this.stage,
            n = t.getTimer(),
            a = r.$displayList.drawToSurface(),
            o = t.getTimer();
          e && this.showFPS && this.fps.update(a, o - n, i);
        }),
        (n.prototype.updateStageSize = function(e, i) {
          ...
          (r.$stageWidth = e),
            (r.$stageHeight = i),
            t.nativeRender
              ? egret_native.nrResize(e, i)
              : (this.screenDisplayList.setClipRect(e, i),
                this.stageDisplayList &&
                  this.stageDisplayList.setClipRect(e, i)),
            r.dispatchEventWith(t.Event.RESIZE);
        }),
        n
      );
    })(t.HashObject);
    (e.Player = n), __reflect(n.prototype, 'egret.sys.Player');
    var a,
      o,
      s = [],
      h = [],
    ...
    (e.$logToFPS = function(t) {
      return a ? void a.updateInfo(t) : void s.push(t);
    }),
      (e.$warnToFPS = function(t) {
        return a ? void a.updateWarn(t) : void h.push(t);
      }),
      (e.$errorToFPS = function(t) {
        return a ? void a.updateError(t) : void c.push(t);
      });
    var l = (function(e) {
      function i(i, r, n, a, o) {
        ...
        (s.showFPS = r),
          ...
          (s.touchEnabled = !1),
          (s.styles = o),
          (s.fpsDisplay = new t.FPSDisplay(i, r, n, a, o)),
          s.addChild(s.fpsDisplay);
        var h;
        try {
          h = a ? new RegExp(a) : null;
        } catch (c) {
          t.log(c);
        }
        return (
          (s.filter = function(t) {
            return h ? h.test(t) : !a || 0 == t.indexOf(a);
          }),
          s
        );
      }
      return (
        ...
        (i.prototype.updateWarn = function(t) {
          t &&
            this.showLog &&
            this.filter(t) &&
            (this.fpsDisplay.updateWarn
              ? this.fpsDisplay.updateWarn(t)
              : this.fpsDisplay.updateInfo('[Warning]' + t));
        }),
        (i.prototype.updateError = function(t) {
          t &&
            this.showLog &&
            this.filter(t) &&
            (this.fpsDisplay.updateError
              ? this.fpsDisplay.updateError(t)
              : this.fpsDisplay.updateInfo('[Error]' + t));
        }),
        i
      );
    })(t.Sprite);
    __reflect(l.prototype, 'FPSImpl'),
      (__global.FPS = l),
      (t.warn = function() {
  ...
  (function(t) {
    if (((t.nativeRender = __global.nativeRender), t.nativeRender)) {
      ...
      if (r > e) {
        t.nativeRender = !1;
        var n = '需要升级微端版本到 0.1.2 才可以开启原生渲染加速';
      ...
      return (
        ...
        (i.prototype.calculateStageSize = function(e, i, r, n, a) {
          ...
          return (
            ...
            o % 2 != 0 && (o += 1),
            s % 2 != 0 && (s += 1),
            { stageWidth: h, stageHeight: c, displayWidth: o, displayHeight: s }
          );
        }),
        i
      );
        ...
        (i.prototype.update = function() {
          for (
            var i = t.getTimer(),
              ...
              a = r.length,
              o = e.$requestRenderingFlag,
              s = t.getTimer(),
              h = t.lifecycle.contexts,
              c = 0,
              l = h;
            c < l.length;
            c++
          ...
          if (((this.lastTimeStamp = s), f >= this.frameDeltaTime))
            this.lastCount = this.frameInterval;
          else {
            if (((this.lastCount -= 1e3), this.lastCount > 0))
              return void (o && this.render(!1, this.costEnterFrame + d - i));
            this.lastCount += this.frameInterval;
          }
    ...
    var i = (function(e) {
      ...
      return (
        ...
        (i.$updateTextureDataWithScale9Grid = function(
          ...
          if (
            (x + S) * t.$TextureScaleFactor > p ||
            (T + R) * t.$TextureScaleFactor > d
          )
            return void e.drawImage(n, a, o, s, h, c, p, d);
          var B = h,
            N = B + b,
            j = B + (p - M),
            k = p - b - M,
            ...
            H = d - m - A;
          T > 0 &&
            (x > 0 && e.drawImage(O, P, x, T, B, L, b, m),
            _ > 0 && e.drawImage(w, P, _, T, N, L, k, m),
            S > 0 && e.drawImage(E, P, S, T, j, L, M, m)),
            D > 0 &&
              (x > 0 && e.drawImage(O, F, x, D, B, I, b, H),
              _ > 0 && e.drawImage(w, F, _, D, N, I, k, H),
              S > 0 && e.drawImage(E, F, S, D, j, I, M, H)),
            R > 0 &&
              (x > 0 && e.drawImage(O, C, x, R, B, U, b, A),
              _ > 0 && e.drawImage(w, C, _, R, N, U, k, A),
              S > 0 && e.drawImage(E, C, S, R, j, U, M, A));
        }),
    ...
    var i = ['none', 'round', 'square'],
      ...
      n = (function(n) {
        ...
        return (
          ...
          (a.prototype.lineStyle = function(n, a, o, s, h, c) {
            void 0 === o && (o = 1),
              void 0 === c && (c = 3),
    ...
    var e = (function(t) {
      ...
      return (
        ...
        (e.prototype.setLineDash = function(t) {
          this.$commands[this.commandPosition++] = 5;
          var e = this.dataPosition;
          (this.$data[e++] = t), (this.dataPosition = e);
        }),
        e
      );
    })(t.Path2D);
...
!(function(t) {
  ...
  function a(t, e, i, r) {
    for (
      ...
      var w = t[D + 0],
        ...
        S = t[D + 2],
        P = t[D + 3];
      (t[D + 0] = n * w + a * E + o * S + s * P + h),
        (t[D + 1] = c * w + l * E + u * S + p * P + d),
        (t[D + 2] = f * w + g * E + $ * S + y * P + v),
        (t[D + 3] = b * w + m * E + x * S + T * P + _);
    }
  }
  ...
  function s(t, e, i, r) {
    var a;
    a = T ? new Uint8ClampedArray(4 * e) : new Array(4 * e);
  ...
  function h(t, e, i, r) {
    var n;
    n = T ? new Uint8ClampedArray(4 * i) : new Array(4 * i);
    for (var a = 4 * e, o = 2 * r + 1, s = 0; e > s; s++) {
      ...
      for (
        var g = h, $ = h + i * a, v = 0, b = h - r * a, m = h + (r + 1) * a;
        $ > g;
        g += a, v += 4, m += a, b += a
      )
        0 === p
          ? ((n[v + 0] = 0), (n[v + 1] = 0), (n[v + 2] = 0), (n[v + 3] = 0))
          : ((n[v + 0] = c / p),
            (n[v + 1] = l / p),
            (n[v + 2] = u / p),
            (n[v + 3] = p / o)),
          ...
          d || 0 == d
            ...
            : (f || 0 == f) &&
              ...
              (u += -t[b + 2] * f),
              (p += -f));
      for (var x = 4 * s, $ = x + i * a, _ = 0; $ > x; x += a, _ += 4)
        (t[x + 0] = n[_ + 0]),
          (t[x + 1] = n[_ + 1]),
          (t[x + 2] = n[_ + 2]),
          (t[x + 3] = n[_ + 3]);
  ...
  function l(t, e) {
    e || (e = [0, 0, 0, 0]);
    var i;
    T ? (i = new Uint8ClampedArray(t)) : ((i = new Array(t.length)), n(i, t));
    for (
      var r = e[0], a = e[1], o = e[2], s = e[3], h = 0, c = i.length;
      c > h;
      h += 4
    ) {
      var l = i[h + 3];
      ...
      for (var l = 0; i > l; l++) {
        ...
        if (!(0 > u || u > i))
          for (var p = 0; e > p; p++) {
            ...
            0 > d ||
              d > e ||
              ((s[4 * (u * e + d) + 0] = o[4 * (l * e + p) + 0]),
              (s[4 * (u * e + d) + 1] = o[4 * (l * e + p) + 1]),
              (s[4 * (u * e + d) + 2] = o[4 * (l * e + p) + 2]),
              (s[4 * (u * e + d) + 3] = o[4 * (l * e + p) + 3]));
          }
      }
      n(o, s);
    }
  ...
  function g(t, e, i, r, a, o, s, h, c, l, u, p) {
    var d;
    d = T ? new Uint8ClampedArray(t.length) : new Array(t.length);
    for (
      var g,
        $,
        y = r[3],
      ...
      for (var P = 0; i > P; P++) {
        ...
        j = Math.max(j, 1e-4);
        var Y = (R / M) * c * y * (1 - l) * Math.max(Math.min(p, u), 1 - j),
          W = ((M - R) / M) * c * y * l * j;
        j = Math.max(j * u * (1 - p), 1e-4);
        var G = W / (W + j),
          z = f(A, r[0], G),
          V = f(B, r[1], G),
          q = f(N, r[2], G),
  ...
  var $ = ['source-over', 'lighter', 'destination-out'],
    y = 'source-over';
  t.BLACK_COLOR = '#000000';
  var v = { none: 'butt', square: 'square', round: 'round' },
    b = [],
    m = [],
    x = (function() {
      function n() {
      ...
      return (
        (n.prototype.render = function(e, i, r, n) {
          this.nestLevel++;
          var a = i.context;
          ...
          if (
            (r.$invertInto(s),
            a.transform(s.a, s.b, s.c, s.d, 0, 0),
            t.Matrix.release(s),
            this.nestLevel--,
            0 === this.nestLevel)
          ) {
        ...
        (n.prototype.drawDisplayObject = function(e, i, r, n, a) {
          ...
          if (
            (h && !a
              ? ((e.$cacheDirty ||
                  e.$renderDirty ||
                  h.$canvasScaleX != t.sys.DisplayList.$canvasScaleX ||
                  h.$canvasScaleY != t.sys.DisplayList.$canvasScaleY) &&
                  (s += h.drawToSurface()),
                (o = h.$renderNode))
              : (o = e.$renderDirty ? e.$getRenderNode() : e.$renderNode),
            (e.$cacheDirty = !1),
            o)
          ) {
          ...
          if (c)
            for (var l = c.length, u = 0; l > u; u++) {
              ...
              if (p.$useTranslate) {
                ...
                (d = r + p.$x - p.$anchorOffsetX),
                  (f = n + p.$y - p.$anchorOffsetY);
              var $ = void 0;
              switch (
                (1 != p.$alpha &&
                  (($ = i.globalAlpha), (i.globalAlpha *= p.$alpha)),
                p.$renderMode)
              ) {
                case 1:
                  break;
        ...
        (n.prototype.drawWithFilter = function(t, e, i, r) {
          ...
          var d = this.createRenderBuffer(p.width - p.x, p.height - p.y, !0),
            f = d.context;
          if (
            ((s += t.$mask
              ? this.drawWithClip(t, f, -p.x, -p.y)
              : t.$scrollRect || t.$maskRect
              ? this.drawWithScrollRect(t, f, -p.x, -p.y)
              : this.drawDisplayObject(t, f, -p.x, -p.y)),
            s > 0)
          ) {
            u && (e.globalCompositeOperation = n), s++;
            for (
              var v = f.getImageData(0, 0, d.surface.width, d.surface.height),
                b = 0;
              l > b;
              b++
            ) {
              var x = h[b];
              if ('colorTransform' == x.type)
                a(v.data, d.surface.width, d.surface.height, x.$matrix);
              else if ('blur' == x.type)
                o(
                  v.data,
                  d.surface.width,
                ...
                var T = x.$red,
                  ...
                  D = x.$blue,
                  O = x.$alpha;
                x.$inner || x.$knockout || x.$hideObject
                  ? g(
                      v.data,
                      d.surface.width,
                      d.surface.height,
            ...
            f.putImageData(v, 0, 0),
              (e.globalAlpha = 1),
              e.drawImage(d.surface, i + p.x, r + p.y),
        ...
        (n.prototype.drawWithClip = function(e, i, r, n) {
          ...
          if (!(c || (e.$children && 0 != e.$children.length)))
            return (
              h &&
                (i.save(),
                i.beginPath(),
                i.rect(h.x + r, h.y + n, h.width, h.height),
                i.clip()),
          ...
          if (
            ...
            var d = this.drawDisplayObject(c, i, r, n);
            return (
          ...
          var f = e.$getOriginalBounds(),
            g = this.createRenderBuffer(f.width, f.height),
            v = g.context;
          if (!v) return (o += this.drawDisplayObject(e, i, r, n));
          if (((o += this.drawDisplayObject(e, v, -f.x, -f.y)), c)) {
            var p = t.Matrix.create();
            if (
              (p.copyFrom(c.$getConcatenatedMatrix()),
              c.$getConcatenatedMatrixAt(e, p),
              p.translate(-f.x, -f.y),
              (u && 1 == u.$getRenderCount()) || c.$displayList)
            )
              (v.globalCompositeOperation = 'destination-in'),
                v.save(),
                v.setTransform(p.a, p.b, p.c, p.d, p.tx, p.ty),
                (o += this.drawDisplayObject(c, v, 0, 0)),
                v.restore();
            else {
              var m = this.createRenderBuffer(f.width, f.height),
                x = m.context;
              x.setTransform(p.a, p.b, p.c, p.d, p.tx, p.ty),
                (o += this.drawDisplayObject(c, x, 0, 0)),
                (v.globalCompositeOperation = 'destination-in'),
                (v.globalAlpha = 1),
                v.drawImage(m.surface, 0, 0),
                b.push(m);
            }
            t.Matrix.release(p);
          }
          return (
            o > 0 &&
              ...
              h &&
                ...
                i.clip()),
              (i.globalAlpha = 1),
              i.drawImage(g.surface, r + f.x, n + f.y),
              h && i.restore(),
              s && (i.globalCompositeOperation = y)),
            b.push(g),
            o
        ...
        (n.prototype.drawWithScrollRect = function(t, e, i, r) {
          ...
          return a.isEmpty()
            ? n
            : (t.$scrollRect && ((i -= a.x), (r -= a.y)),
              e.save(),
              e.beginPath(),
              e.rect(a.x + i, a.y + r, a.width, a.height),
              e.clip(),
              (n += this.drawDisplayObject(t, e, i, r)),
              e.restore(),
              n);
        }),
        ...
        (n.prototype.renderBitmap = function(t, e) {
          ...
          if (g && 8 == s) {
            ...
            f++,
              ...
              S.drawImage(i.source, v, m, x, T, 0, 0, O, w),
              f++;
            var P = S.getImageData(0, 0, O, w);
            a(P.data, O, w, g.$matrix),
          ...
          return (
            p
              ? e.restore()
              : (l && (e.globalCompositeOperation = y),
                u == u && (e.globalAlpha = d)),
            r && (e.$offsetX = r),
            n && (e.$offsetY = n),
            f
        ...
        (n.prototype.renderText = function(i, r) {
          ...
          for (var n = i.drawData, a = n.length, o = 0; a > o; ) {
            ...
            (r.fillStyle = t.toColorString(u)),
              ...
              d &&
                ((r.lineWidth = 2 * d),
                r.strokeText(c, s + r.$offsetX, h + r.$offsetY)),
              r.fillText(c, s + r.$offsetX, h + r.$offsetY);
          }
        }),
        (n.prototype.renderGraphics = function(e, n, a) {
          var o = e.drawData,
            s = o.length;
          a = !!a;
          for (var h = 0; s > h; h++) {
            ...
            switch (c.type) {
              case 1:
                var l = c;
                (n.fillStyle = a ? t.BLACK_COLOR : i(l.fillColor, l.fillAlpha)),
                  this.renderPath(c, n),
                  this.renderingMask ? n.clip() : n.fill();
                break;
              case 2:
                var u = c;
                (n.fillStyle = a
                ...
                var p = u.matrix;
                this.renderPath(c, n),
                  n.transform(p.a, p.b, p.c, p.d, p.tx, p.ty),
                  n.fill(),
                  n.restore();
                break;
              case 3:
                ...
                (n.lineWidth = f),
                  (n.strokeStyle = a
                    ? t.BLACK_COLOR
                    : i(d.lineColor, d.lineAlpha)),
                  (n.lineCap = v[d.caps]),
                  (n.lineJoin = d.joints),
                  (n.miterLimit = d.miterLimit);
                var g = 1 === f || 3 === f;
                g && n.translate(0.5, 0.5),
                  this.renderPath(c, n),
                  n.stroke(),
                  g && n.translate(-0.5, -0.5);
            }
        ...
        (n.prototype.renderPath = function(t, e) {
          e.beginPath();
          for (
            var i = t.$data, r = t.$commands, n = r.length, a = 0, o = 0;
            n > o;
            o++
          ) {
            var s = r[o];
        ...
        (n.prototype.renderGroup = function(t, e) {
          ...
          return (
            a && e.restore(), i && (e.$offsetX = i), r && (e.$offsetY = r), o
          );
        }),
        (n.prototype.createRenderBuffer = function(e, i, r) {
          var n = r ? m.pop() : b.pop();
          return (
            n ? n.resize(e, i, !0) : (n = new t.sys.CanvasRenderBuffer(e, i)), n
          );
        }),
        n
      );
  ...
  var T = !1;
  try {
    T = void 0 !== typeof Uint8ClampedArray;
  } catch (_) {}
})(egret || (egret = {}));
var egret;
!(function(t) {
...
!(function(t) {
  ...
  var i = (function() {
    ...
    return (
      ...
      Object.defineProperty(e, 'runtimeType', {
        get: function() {
      ...
      Object.defineProperty(e, 'engineVersion', {
        get: function() {
          return '5.1.3';
        },
        enumerable: !0,
      ...
      Object.defineProperty(e, 'renderMode', {
        get: function() {
          return e.$renderMode;
        },
        enumerable: !0,
      ...
      Object.defineProperty(e, 'boundingClientWidth', {
        get: function() {
          return e.$boundingClientWidth;
        },
        enumerable: !0,
        configurable: !0
      }),
      Object.defineProperty(e, 'boundingClientHeight', {
        get: function() {
          return e.$boundingClientHeight;
        },
        enumerable: !0,
        configurable: !0
      }),
...
!(function(t) {
  ...
  (function(t) {
    ...
    !(function(t) {
      ...
      for (
        var r = ['normal', 'add', 'erase'], n = {}, a = r.length, o = 0;
        a > o;
        o++
      ) {
        var s = r[o];
  ...
  var e = (function(e) {
    ...
    return (
      ...
      (i.prototype.$setText = function(t) {
        ...
        return t == e.$text
          ? !1
          : ((e.$text = t), e.$invalidateContentBounds(), !0);
      }),
      (i.prototype.$getWidth = function() {
        var t = this,
          e = t.$textFieldWidth;
      ...
      (i.prototype.$setWidth = function(t) {
        var e = this;
        return 0 > t || t == e.$textFieldWidth
          ? !1
          : ((e.$textFieldWidth = t), e.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setHeight = function(t) {
        var e = this;
        return 0 > t || t == e.$textFieldHeight
          ? !1
          : ((e.$textFieldHeight = t), e.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setLineSpacing = function(t) {
        var e = this;
        return e.$lineSpacing == t
          ? !1
          : ((e.$lineSpacing = t), e.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setLetterSpacing = function(t) {
        var e = this;
        return e.$letterSpacing == t
          ? !1
          : ((e.$letterSpacing = t), e.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setTextAlign = function(t) {
        var e = this;
        return e.$textAlign == t
          ? !1
          : ((e.$textAlign = t), e.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setVerticalAlign = function(t) {
        var e = this;
        return e.$verticalAlign == t
          ? !1
          : ((e.$verticalAlign = t), e.$invalidateContentBounds(), !0);
      }),
      (i.prototype.$updateRenderNode = function() {
        var e = this,
          r = this.$getTextLines(),
        ...
        if (0 != n) {
          ...
          t.nativeRender ||
            ((a = this.$renderNode),
            h.$texture && (a.image = h.$texture.$bitmapData),
            (a.smoothing = e.$smoothing));
          for (
            var c = h._getFirstCharHeight(),
              l = Math.ceil(c * i.EMPTY_FACTOR),
              u = !isNaN(e.$textFieldHeight),
              p = e.$textWidth,
              d = e.$textFieldWidth,
              f = e.$textFieldHeight,
              g = e.$textAlign,
            ...
            if (g != t.HorizontalAlign.LEFT) {
              var _ = d > p ? d : p;
              g == t.HorizontalAlign.RIGHT
                ? (T += _ - s[v])
                : g == t.HorizontalAlign.CENTER &&
                  (T += Math.floor((_ - s[v]) / 2));
            }
            for (var D = 0; x > D; D++) {
              var O = m.charAt(D),
                w = h.getTexture(O);
              if (w) {
                ...
                t.nativeRender
                  ? o.push(
                      ...
                      T + w.$offsetX,
                      $ + w.$offsetY,
                      w.$getScaleBitmapWidth(),
                      w.$getScaleBitmapHeight(),
                      w.$sourceWidth,
                      w.$sourceHeight
                    )
                  : ((a.imageWidth = w.$sourceWidth),
                    (a.imageHeight = w.$sourceHeight),
                    a.drawImage(
                      w.$bitmapX,
                      w.$bitmapY,
                      E,
                  ...
                  (T +=
                    (h.getConfig(O, 'xadvance') || w.$getTextureWidth()) +
                    e.$letterSpacing);
          ...
          if (t.nativeRender) {
            ...
            var P = e.$getContentBounds();
            e.$nativeDisplayObject.setWidth(P.width),
              e.$nativeDisplayObject.setHeight(P.height);
          }
        }
      }),
      (i.prototype.$measureContentBounds = function(t) {
      ...
      (i.prototype.$getTextLines = function() {
        ...
        var o = [];
        if (((r.$lineHeights = o), !r.$text || !r.$font))
          return (r.$textWidth = 0), (r.$textHeight = 0), n;
        for (
          var s,
            h,
            c,
            ...
            g = 0,
            $ = 0,
            y = !isNaN(r.$textFieldWidth),
            v = r.$textFieldWidth,
            b = r.$textFieldHeight,
            m = r.$font,
            x = m._getFirstCharHeight(),
            T = Math.ceil(x * i.EMPTY_FACTOR),
            _ = r.$text,
            D = _.split(/(?:\r\n|\r|\n)/),
            O = D.length,
            w = !0,
          ...
          for (var F = 0; P > F; F++) {
            ...
            if (
              ...
              (S = S.substring(F)),
                (P = S.length),
                (F = 0),
                (l = F == P - 1 ? R : m.getConfig(C, 'xadvance') || R),
                (c = M);
            } else
              (l += F == P - 1 ? R : m.getConfig(C, 'xadvance') || R),
                (c = Math.max(M, c));
        ...
        return (
          v > d &&
            ((j = r.$textAlign),
            j == t.HorizontalAlign.RIGHT
              ? (this.$textStartX = v - d)
              : j == t.HorizontalAlign.CENTER &&
                (this.$textStartX = Math.floor((v - d) / 2))),
          b > f &&
            ((j = r.$verticalAlign),
            j == t.VerticalAlign.BOTTOM
              ? (this.$textStartY = b - f)
              : j == t.VerticalAlign.MIDDLE &&
                (this.$textStartY = Math.floor((b - f) / 2))),
          n
        );
      }),
      (i.EMPTY_FACTOR = 0.33),
        ...
        for (var i = 0, r = e.length; r > i; ) {
          ...
          if (0 > n) this.addToResultArr(e.substring(i)), (i = r);
            ...
            -1 == a
              ...
              : '/' == e.charAt(n + 1)
              ? this.stackArray.pop()
              : this.addToArray(e.substring(n + 1, a)),
              (i = a + 1);
          }
        }
        ...
        if ('i' == t.charAt(0) || 'b' == t.charAt(0) || 'u' == t.charAt(0))
          ...
          for (var r = 0, n = void 0; (n = t.match(this.getHeadReg())); ) {
            ...
            (t = t.substring(a.length).trim()),
              '"' == t.charAt(0)
                ? ((r = t.indexOf('"', 1)), (o = t.substring(1, r)), (r += 1))
                : "'" == t.charAt(0)
                ? ((r = t.indexOf("'", 1)), (o = t.substring(1, r)), (r += 1))
                : ((o = t.match(/(\S)+/)[0]), (r = o.length)),
              this.addProperty(
                e,
    ...
    return (
      ...
      (i.prototype.focusHandler = function(e) {
        this._isFocus ||
          ((this._isFocus = !0),
          e.showing ||
            ((this._text.$isTyping = !0), this._text.$invalidateTextField()),
        ...
        this._text.visible &&
          (this._isFocus ||
            ...
            t.callLater(function() {
              e.tempStage.addEventListener(
                t.TouchEvent.TOUCH_BEGIN,
                e.onStageDownHandler,
                e
              );
            }, this),
            this.stageText.$show()));
    ...
    r = (function(r) {
      ...
      return (
        ...
        (n.prototype.$setText = function(t) {
          ...
          return (
            this.inputUtils && this.inputUtils._setText(this.$TextField[13]), e
          );
        }),
        ...
        (n.prototype.fillBackground = function(e) {
          ...
          if (r[33] || r[31] || (e && e.length > 0)) {
            ...
            if (
              (r[33] &&
                ((a = i.beginFill(r[34])),
                a.drawRect(0, 0, this.$getWidth(), this.$getHeight())),
              r[31] &&
                ((o = i.lineStyle(1, r[32])),
                o.drawRect(0, 0, this.$getWidth() - 1, this.$getHeight() - 1)),
              e && e.length > 0)
            )
              for (var s = r[2], h = -1, c = e.length, l = 0; c > l; l += 4) {
                var u = e[l],
                  ...
                  f = e[l + 3] || s;
                (0 > h || h != f) &&
                  ((h = f), (o = i.lineStyle(2, f, 1, t.CapsStyle.NONE))),
                  o.moveTo(u, p),
                  o.lineTo(u + d, p);
              }
          }
        ...
        (n.prototype.$invalidateTextField = function() {
          var e = this;
          if (((e.$renderDirty = !0), (e.$TextField[18] = !0), t.nativeRender))
        ...
        (n.prototype.$updateRenderNode = function() {
          if (this.$TextField[24] == t.TextFieldType.INPUT) {
            if ((this.inputUtils._updateProperties(), this.$isTyping))
              ...
              for (
                ...
                if ('' == $[y]) y == v - 1 && (b = !1);
                  ...
                  if (isNaN(a))
                    (h += m),
                      (c += $[y].length),
                      o.elements.push({ width: m, text: $[y], style: f.style }),
                      y == v - 1 && (b = !1);
                  else if (a >= h + m)
                    o.elements.push({ width: m, text: $[y], style: f.style }),
                      (h += m),
                    ...
                    for (var O = D.length, w = 0; O > x; x++) {
                      var E = D[x].length,
                        S = !1;
                      if (1 == E && O - 1 > x) {
                        var P = D[x].charCodeAt(0),
                          F = D[x + 1].charCodeAt(0);
                        if (P >= 55296 && 56319 >= P && 56320 == (64512 & F)) {
                          var C = D[x] + D[x + 1];
                          (E = 2), (S = !0), (m = e(C, r, f.style));
                        } else m = e(D[x], r, f.style);
                      } else m = e(D[x], r, f.style);
                      if (0 != h && h + m > a && h + x != 0) break;
                      if (T + m > a)
                        for (
                          var R = D[x].match(/./g), M = 0, A = R.length;
                          A > M;
                          M++
                        ) {
                          var E = R[M].length,
                            B = !1;
                          if (1 == E && A - 1 > M) {
                            var P = R[M].charCodeAt(0),
                              F = R[M + 1].charCodeAt(0);
                            if (
                              P >= 55296 &&
                              56319 >= P &&
                              56320 == (64512 & F)
                              ...
                              var C = R[M] + R[M + 1];
                              (E = 2), (B = !0), (m = e(C, r, f.style));
                            } else m = e(R[M], r, f.style);
                          } else m = e(R[M], r, f.style);
                          if (M > 0 && h + m > a) break;
                          (w += E), (T += m), (h += m), (c += w), B && M++;
                        }
        ...
        (n.prototype.drawText = function() {
          ...
          s = Math.round(s);
          for (
            var u = t.TextFieldUtils.$getHalign(this),
              p = 0,
              d = [],
              f = h,
              g = i[29];
            ...
            for (var v = 0, b = $.elements.length; b > v; v++) {
              ...
              e.drawText(p, s + (y - x) / 2, m.text, m.style),
                m.style.underline &&
                  d.push(p, s + y / 2, m.width, m.style.textColor),
                (p += m.width);
            }
            s += y / 2 + i[1];
          }
  ...
  var e = (function() {
    ...
    return (
        ...
        if (!isNaN(n) && n > r) {
          ...
          return (
            i.$TextField[10] == t.VerticalAlign.MIDDLE
              ? (a = 0.5)
              : i.$TextField[10] == t.VerticalAlign.BOTTOM && (a = 1),
            a
          );
        }
        return 0;
      ...
      (e.$getTextElement = function(t, i, r) {
        ...
        return n &&
          a[n.lineIndex] &&
          a[n.lineIndex].elements[n.textElementIndex]
          ? a[n.lineIndex].elements[n.textElementIndex]
          : null;
      }),
      (e.$getHit = function(t, i, r) {
        ...
        for (var y = 0, p = 0; p < f.elements.length; p++) {
          ...
          else if (i > y) return { lineIndex: a - 1, textElementIndex: p };
        }
        return null;
      }),
  ...
  var e = (function() {
    ...
    return (
      ...
      (t.decode = function(t) {
        ...
        for (
          var h = new ArrayBuffer(e), c = new Uint8Array(h), l = 0;
          i > l;
          l += 4
        )
...
!(function(t) {
  ...
  var i = (function() {
      ...
      if (t) {
        ...
        if (
          (t instanceof Uint8Array
            ? ((a = t), (n = t.length))
            : ((n = t.byteLength), (a = new Uint8Array(t))),
          0 == i)
        )
          r = new Uint8Array(n);
        else {
    ...
    return (
      Object.defineProperty(i.prototype, 'endian', {
        get: function() {
      ...
      (i.prototype.writeBytes = function(t, e, i) {
        ...
        0 > e ||
          0 > i ||
          ((r = 0 == i ? t.length - e : Math.min(t.length - e, i)),
          r > 0 &&
          ...
          if (this.inRange(n, 55296, 57343)) this.encoderError(n);
            ...
            for (
              this.inRange(n, 128, 2047)
                ...
                ? ((a = 2), (o = 224))
                : this.inRange(n, 65536, 1114111) && ((a = 3), (o = 240)),
                r.push(this.div(n, Math.pow(64, a)) + o);
              a > 0;
      ...
      (i.prototype.decodeUTF8 = function(t) {
        for (
          var e, i = !1, r = 0, n = '', a = 0, o = 0, s = 0, h = 0;
          t.length > r;
          ...
          if (c == this.EOF_byte)
            ...
            if (((s += 1), (a += (c - 128) * Math.pow(64, o - s)), s !== o))
              e = null;
            else {
              var l = a,
                u = h;
              (a = 0),
                ...
                (h = 0),
                (e =
                  this.inRange(l, u, 1114111) && !this.inRange(l, 55296, 57343)
                    ? l
                    : this.decoderError(i, c));
            }
          else
            (a = 0),
              (o = 0),
...
!(function(t) {
  ...
  function i(t, e, i) {
    ...
    if (null != o) {
      ...
      return (
        (a = Object.getOwnPropertyDescriptor(o, i).get), (r[i] = a), a.call(e)
      );
    }
  }
