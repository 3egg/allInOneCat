...
!(function(t) {
    ...
    return (
      ...
      (e.getElasticInOut = function(t, e) {
        ...
        return function(i) {
          ...
          return (i *= 2) < 1
            ? -0.5 *
                (t * Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - s) * n) / e))
            : t *
                Math.pow(2, -10 * (i -= 1)) *
                Math.sin(((i - s) * n) / e) *
                0.5 +
  ...
  (t.Ease = e),
    __reflect(e.prototype, 'http://huiben.lanyaotech.com/fanpai/js/egret.Ease');
})(egret || (egret = {}));
var egret;
!(function(t) {
  var e = (function(e) {
    ...
    return (
      ...
      (n._register = function(e, i) {
        var s = e._target,
          r = n._tweens;
        if (i)
          s && (s.tween_count = s.tween_count > 0 ? s.tween_count + 1 : 1),
            r.push(e),
            n._inited ||
              ((n._lastTime = t.getTimer()),
              t.ticker.$startTick(n.tick, null),
              (n._inited = !0));
        else {
          s && s.tween_count--;
            ...
            if ('action' == this._steps[a].type)
              0 != e &&
                (this._useTicks
                  ...
                  : 1 == e && r > n
                  ? (r != this.duration &&
                      this._runAction(this._steps[a], r, this.duration),
                    this._runAction(this._steps[a], 0, n, !0))
                  : this._runAction(this._steps[a], r, n));
      ...
      (n.prototype.setPaused = function(t) {
        return this.paused == t
          ? this
          : ((this.paused = t), n._register(this, !t), this);
      }),
      ...
      (n.prototype._addAction = function(t) {
        return (
          (t.t = this.duration), (t.type = 'action'), this._steps.push(t), this
        );
      }),
...
!(function(t) {
  ...
  !(function(e) {
    ...
    (e.To = r),
      __reflect(
        r.prototype,
        'http://huiben.lanyaotech.com/fanpai/js/egret.tween.To'
      );
    var o = (function(t) {
      function e() {
        var e = (null !== t && t.apply(this, arguments)) || this;
    ...
    (e.Wait = o),
      __reflect(
        o.prototype,
        'http://huiben.lanyaotech.com/fanpai/js/egret.tween.Wait'
      );
    var u = (function(t) {
      function e() {
        var e = (null !== t && t.apply(this, arguments)) || this;
    ...
    (e.Set = u),
      __reflect(
        u.prototype,
        'http://huiben.lanyaotech.com/fanpai/js/egret.tween.Set'
      );
    var a = (function(t) {
      function e() {
        var e = (null !== t && t.apply(this, arguments)) || this;
    ...
    (e.Tick = a),
      __reflect(
        a.prototype,
        'http://huiben.lanyaotech.com/fanpai/js/egret.tween.Tick'
      );
    var p = (function(e) {
      function i() {
        ...
        (i.prototype.play = function(t) {
          this.tween
            ? (this.tween.setPaused(!1),
              this.isStop && void 0 == t && ((t = 0), (this.isStop = !1)),
